...
val Icons.Rr.Skewer: ImageVector
    get() = _Skewer ?: UXIcon(name = "Skewer") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(14.99f, 12.78f)
                arcToRelative(2.89f, 2.89f, 0f, isMoreThanHalf = false, isPositiveArc = true, -3.76f, -3.76f)
                arcToRelative(0.13f, 0.13f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.14f, 0.02f)
                lineToRelative(3.6f, 3.6f)
                arcTo(0.13f, 0.13f, 0f, isMoreThanHalf = false, isPositiveArc = true, 14.99f, 12.78f)
                close()
            }
        }.also { _Skewer = it}
