...
val Icons.Rr.KPopHeadphones: ImageVector
    get() = _KPopHeadphones ?: UXIcon(name = "KPopHeadphones") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(19f, 10.17f)
                ...
                close()
                moveTo(4f, 16.05f)
                curveToRelative(-1.15f, -0.43f, -2f, -1.77f, -2f, -3.05f)
                ...
                curveToRelative(1.38f, 0f, 2.48f, -1f, 2.48f, -2.5f)
