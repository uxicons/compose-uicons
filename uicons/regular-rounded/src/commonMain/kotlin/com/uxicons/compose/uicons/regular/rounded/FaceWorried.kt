...
val Icons.Rr.FaceWorried: ImageVector
    get() = _FaceWorried ?: UXIcon(name = "FaceWorried") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.62f, -0.79f, -1.63f, -1.46f, -2.44f, -1.65f)
                ...
                close()
                moveTo(16.91f, 17.77f)
                curveToRelative(0.4f, 0.6f, -0.16f, 1.36f, -0.88f, 1.21f)
                curveToRelative(-0.93f, -0.2f, -2.0f, -0.98f, -4.03f, -0.98f)
                curveToRelative(-2.03f, 0f, -3.02f, 0.79f, -3.95f, 0.98f)
                curveToRelative(-0.72f, 0.15f, -1.27f, -0.62f, -0.88f, -1.21f)
                curveToRelative(0.85f, -1.28f, 2.37f, -2.77f, 4.87f, -2.77f)
                reflectiveCurveToRelative(4.02f, 1.48f, 4.87f, 2.77f)
                close()
            }
