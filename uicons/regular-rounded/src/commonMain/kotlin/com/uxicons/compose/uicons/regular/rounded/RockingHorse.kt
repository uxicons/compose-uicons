...
val Icons.Rr.RockingHorse: ImageVector
    get() = _RockingHorse ?: UXIcon(name = "RockingHorse") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 0.04f, -0.04f, 3.5f, -2f, 3.5f)
                curveToRelative(-0.95f, 0.03f, -1.83f, 0.17f, -2.65f, 0.36f)
                ...
                curveToRelative(-1.18f, -0.55f, -2.5f, -1.0f, -3.97f, -1.26f)
                curveToRelative(0.72f, -1.18f, 0.97f, -2.7f, 0.97f, -3.72f)
                curveToRelative(0.0f, -0.38f, 0.1f, -3.44f, 2.56f, -3.94f)
                curveToRelative(0.9f, 2.33f, 2.76f, 3.23f, 4.16f, 3.9f)
