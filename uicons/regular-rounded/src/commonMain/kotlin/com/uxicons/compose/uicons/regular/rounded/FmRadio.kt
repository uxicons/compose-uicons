...
val Icons.Rr.FmRadio: ImageVector
    get() = _FmRadio ?: UXIcon(name = "FmRadio") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.23f, -0.51f, -0.81f, -0.73f, -1.32f, -0.51f)
                curveTo(19.59f, 0.08f, 2.7f, 7.58f, 2.65f, 7.61f)
                curveToRelative(-1.57f, 0.84f, -2.65f, 2.48f, -2.65f, 4.39f)
                ...
                verticalLineToRelative(-7f)
                curveToRelative(-0.01f, -1.67f, 1.39f, -3.0f, 3f, -3f)
                horizontalLineToRelative(14f)
                curveToRelative(1.65f, 0f, 3f, 1.35f, 3f, 3f)
                verticalLineToRelative(7f)
                close()
