...
val Icons.Rr.SearchLocation: ImageVector
    get() = _SearchLocation ?: UXIcon(name = "SearchLocation") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(2.02f, 10.02f)
                curveTo(2.02f, 5.61f, 5.61f, 2.02f, 10.02f, 2.02f)
                reflectiveCurveToRelative(8f, 3.59f, 8f, 8f)
                reflectiveCurveToRelative(-3.59f, 8f, -8f, 8f)
                reflectiveCurveTo(2.02f, 14.43f, 2.02f, 10.02f)
                close()
                moveTo(10f, 4f)
                ...
                curveToRelative(0.47f, 0.46f, 1.09f, 0.69f, 1.72f, 0.69f)
