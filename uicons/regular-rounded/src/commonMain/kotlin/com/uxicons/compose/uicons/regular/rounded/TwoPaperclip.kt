...
val Icons.Rr.TwoPaperclip: ImageVector
    get() = _TwoPaperclip ?: UXIcon(name = "TwoPaperclip") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(8.34f, 8.66f)
                ...
                curveToRelative(-0.53f, -0.85f, -1.47f, -1.42f, -2.54f, -1.42f)
                curveToRelative(-1.65f, 0f, -3f, 1.35f, -3f, 3f)
                verticalLineToRelative(16.0f)
                curveToRelative(0f, 0.55f, 0.45f, 1f, 1f, 1f)
                close()
                moveTo(23.93f, 15.12f)
                lineTo(19.44f, 4.11f)
                ...
                curveToRelative(1.53f, -0.62f, 2.27f, -2.38f, 1.64f, -3.91f)
                lineToRelative(-5.86f, -14.24f)
                curveToRelative(-0.21f, -0.51f, -0.79f, -0.76f, -1.3f, -0.54f)
