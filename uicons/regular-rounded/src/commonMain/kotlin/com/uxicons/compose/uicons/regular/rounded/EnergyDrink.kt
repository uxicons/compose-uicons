...
val Icons.Rr.EnergyDrink: ImageVector
    get() = _EnergyDrink ?: UXIcon(name = "EnergyDrink") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(18f, 18.1f)
                curveToRelative(0f, 0.98f, -0.23f, 1.97f, -0.67f, 2.85f)
                curveToRelative(-0.24f, 0.61f, -0.78f, 1.06f, -1.45f, 1.05f)
                horizontalLineToRelative(-7.75f)
                curveToRelative(-0.67f, 0.01f, -1.21f, -0.44f, -1.45f, -1.05f)
                curveToRelative(-0.44f, -0.88f, -0.67f, -1.86f, -0.67f, -2.85f)
                verticalLineToRelative(-10.21f)
                curveToRelative(0f, -0.98f, 0.23f, -1.97f, 0.67f, -2.85f)
                curveToRelative(0.24f, -0.61f, 0.78f, -1.06f, 1.45f, -1.05f)
                horizontalLineToRelative(7.75f)
