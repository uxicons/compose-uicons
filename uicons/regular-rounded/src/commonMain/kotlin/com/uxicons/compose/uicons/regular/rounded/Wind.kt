...
val Icons.Rr.Wind: ImageVector
    get() = _Wind ?: UXIcon(name = "Wind") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(20.89f, 11.11f)
                arcTo(4.99f, 4.99f, 0f, isMoreThanHalf = true, isPositiveArc = false, 12f, 8f)
                ...
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 20.89f, 11.11f)
                close()
                moveTo(11f, 16f)
                lineTo(1f, 16f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, 2f)
