...
val Icons.Rr.Dagger: ImageVector
    get() = _Dagger ?: UXIcon(name = "Dagger") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(11.85f, 15.47f)
                curveToRelative(-2.31f, 2.31f, -4.97f, 4.23f, -7.89f, 5.7f)
                lineToRelative(-1.64f, 0.82f)
                curveToRelative(-0.11f, -0.0f, -0.19f, -0.06f, -0.23f, -0.1f)
                curveToRelative(-0.04f, -0.04f, -0.1f, -0.12f, -0.1f, -0.23f)
                lineToRelative(0.82f, -1.64f)
                curveToRelative(1.47f, -2.92f, 3.39f, -5.58f, 5.7f, -7.89f)
