...
val Icons.Rr.Right: ImageVector
    get() = _Right ?: UXIcon(name = "Right") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(3.97f, 8.99f)
                curveToRelative(-1.09f, 0f, -1.97f, 0.9f, -1.97f, 2.01f)
                verticalLineToRelative(1.98f)
                curveToRelative(0f, 1.11f, 0.89f, 2.01f, 1.97f, 2.01f)
                horizontalLineTo(12f)
                curveToRelative(0.55f, 0f, 1f, 0.45f, 1f, 1f)
                verticalLineToRelative(3.06f)
                curveToRelative(0f, 0.6f, 0.47f, 0.84f, 0.61f, 0.9f)
