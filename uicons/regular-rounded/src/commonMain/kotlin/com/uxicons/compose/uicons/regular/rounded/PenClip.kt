...
val Icons.Rr.PenClip: ImageVector
    get() = _PenClip ?: UXIcon(name = "PenClip") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 0.63f, 0.16f, 1.23f, 0.46f, 1.77f)
                ...
                curveToRelative(0.97f, 0f, 1.89f, -0.38f, 2.57f, -1.07f)
                lineTo(22.93f, 6.21f)
                curveToRelative(0.73f, -0.73f, 1.11f, -1.73f, 1.06f, -2.76f)
                close()
                moveTo(5.8f, 20.52f)
                curveToRelative(-0.62f, 0.62f, -1.7f, 0.62f, -2.32f, 0f)
                ...
                curveToRelative(0.36f, 0f, 0.7f, 0.11f, 0.98f, 0.34f)
