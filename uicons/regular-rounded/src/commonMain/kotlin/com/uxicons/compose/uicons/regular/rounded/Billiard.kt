...
val Icons.Rr.Billiard: ImageVector
    get() = _Billiard ?: UXIcon(name = "Billiard") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(11.86f, 15.52f)
                lineTo(14.86f, 10.52f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.86f, -1.51f)
                horizontalLineToRelative(-4f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, 2f)
                horizontalLineToRelative(2.23f)
                lineToRelative(-2.09f, 3.48f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = false, 1.71f, 1.03f)
                close()
            }
        }.also { _Billiard = it}
