...
val Icons.Rr.Rewind: ImageVector
    get() = _Rewind ?: UXIcon(name = "Rewind") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(13.21f, 14.18f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.59f, 0.19f)
                lineToRelative(5.36f, 3.93f)
                arcTo(1.78f, 1.78f, 0f, isMoreThanHalf = false, isPositiveArc = false, 22f, 16.87f)
                lineTo(22f, 7.13f)
                ...
                lineTo(12.21f, 7.13f)
                arcTo(1.78f, 1.78f, 0f, isMoreThanHalf = false, isPositiveArc = false, 9.37f, 5.69f)
                lineToRelative(-6.64f, 4.87f)
                arcToRelative(1.78f, 1.78f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, 2.88f)
                lineToRelative(6.64f, 4.87f)
                arcToRelative(1.78f, 1.78f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.84f, -1.44f)
                lineTo(12.21f, 15.18f)
