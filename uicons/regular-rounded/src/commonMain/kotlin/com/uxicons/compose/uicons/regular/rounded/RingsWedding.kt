...
val Icons.Rr.RingsWedding: ImageVector
    get() = _RingsWedding ?: UXIcon(name = "RingsWedding") {
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(10.55f, 4.89f)
                arcTo(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 11.9f, 4.45f)
                lineToRelative(1f, -2f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = false, -1.79f, -0.89f)
                lineToRelative(-1f, 2f)
                arcTo(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 10.55f, 4.89f)
                close()
            }
            path(fill = SolidColor(Color.Black)) {
                moveTo(2.1f, 4.45f)
                arcTo(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = false, 3.9f, 3.55f)
                lineToRelative(-1f, -2f)
