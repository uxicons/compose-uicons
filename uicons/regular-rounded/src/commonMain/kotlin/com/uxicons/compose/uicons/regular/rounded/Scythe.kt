...
val Icons.Rr.Scythe: ImageVector
    get() = _Scythe ?: UXIcon(name = "Scythe") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(21.97f, 2.76f)
                lineToRelative(-0.96f, 3.24f)
                horizontalLineToRelative(-11.27f)
                curveToRelative(-2.52f, 0f, -4.84f, 0.75f, -6.67f, 1.41f)
                curveToRelative(3.54f, -3.59f, 7.82f, -5.41f, 12.77f, -5.41f)
                horizontalLineToRelative(5.56f)
                curveToRelative(0.26f, 0f, 0.41f, 0.15f, 0.47f, 0.24f)
                reflectiveCurveToRelative(0.17f, 0.28f, 0.09f, 0.52f)
                close()
            }
        }.also { _Scythe = it}
