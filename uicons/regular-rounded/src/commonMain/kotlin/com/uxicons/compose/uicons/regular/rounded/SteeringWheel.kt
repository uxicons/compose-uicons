...
val Icons.Rr.SteeringWheel: ImageVector
    get() = _SteeringWheel ?: UXIcon(name = "SteeringWheel") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(9f, 21.54f)
                arcToRelative(10.03f, 10.03f, 0f, isMoreThanHalf = false, isPositiveArc = true, -6.93f, -8.4f)
                ...
                lineTo(13f, 21.95f)
                arcToRelative(10.13f, 10.13f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2f, 0f)
                lineTo(11f, 18.01f)
                arcToRelative(5.01f, 5.01f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.6f, -2.38f)
                lineTo(9.77f, 14.48f)
                arcToRelative(4.99f, 4.99f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3.42f, -2.52f)
