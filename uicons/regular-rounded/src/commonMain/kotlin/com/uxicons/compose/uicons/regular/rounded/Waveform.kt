...
val Icons.Rr.Waveform: ImageVector
    get() = _Waveform ?: UXIcon(name = "Waveform") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(15.16f, 24.01f)
                ...
                lineTo(10.58f, 1.29f)
                curveToRelative(0.08f, -0.73f, 0.68f, -1.26f, 1.42f, -1.26f)
                reflectiveCurveToRelative(1.34f, 0.53f, 1.42f, 1.25f)
                lineToRelative(1.78f, 16.46f)
                lineToRelative(1.68f, -13.51f)
                curveToRelative(0.08f, -0.71f, 0.68f, -1.23f, 1.41f, -1.24f)
                horizontalLineToRelative(0.0f)
                ...
                curveToRelative(-0.16f, 0.68f, -0.77f, 1.13f, -1.46f, 1.09f)
                curveToRelative(-0.7f, -0.04f, -1.26f, -0.54f, -1.35f, -1.23f)
                lineToRelative(-1.29f, -9.85f)
                lineToRelative(-1.72f, 13.82f)
                curveToRelative(-0.09f, 0.72f, -0.69f, 1.25f, -1.43f, 1.25f)
                close()
            }
        }.also { _Waveform = it}
