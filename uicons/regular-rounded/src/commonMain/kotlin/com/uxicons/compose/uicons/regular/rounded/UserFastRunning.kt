...
val Icons.Rr.UserFastRunning: ImageVector
    get() = _UserFastRunning ?: UXIcon(name = "UserFastRunning") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(-1.33f, -0.85f)
                lineToRelative(2.27f, -5.6f)
