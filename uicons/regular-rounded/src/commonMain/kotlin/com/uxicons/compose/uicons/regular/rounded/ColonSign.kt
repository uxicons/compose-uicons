...
val Icons.Rr.ColonSign: ImageVector
    get() = _ColonSign ?: UXIcon(name = "ColonSign") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(4.54f, -14.27f)
                curveToRelative(0.54f, 0.51f, 0.99f, 1.12f, 1.34f, 1.81f)
                curveToRelative(0.25f, 0.49f, 0.85f, 0.7f, 1.34f, 0.45f)
                curveToRelative(0.49f, -0.25f, 0.7f, -0.85f, 0.45f, -1.34f)
                curveToRelative(-0.6f, -1.2f, -1.45f, -2.21f, -2.47f, -2.98f)
                lineToRelative(0.75f, -2.36f)
                ...
                curveToRelative(0f, 2.89f, 1.48f, 5.45f, 3.72f, 6.95f)
                ...
                curveToRelative(0.56f, 0.2f, 1.15f, 0.35f, 1.77f, 0.43f)
                ...
                moveTo(9.13f, 19.59f)
                lineTo(14.08f, 4.06f)
                curveToRelative(0.61f, 0.08f, 1.19f, 0.26f, 1.74f, 0.5f)
                lineToRelative(-4.91f, 15.42f)
