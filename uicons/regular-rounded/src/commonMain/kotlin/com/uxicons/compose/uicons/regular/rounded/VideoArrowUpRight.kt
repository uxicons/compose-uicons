...
val Icons.Rr.VideoArrowUpRight: ImageVector
    get() = _VideoArrowUpRight ?: UXIcon(name = "VideoArrowUpRight") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.19f, 2.58f, -2.33f, 4.63f, -4.96f, 4.63f)
                lineTo(5f, 20.0f)
                ...
                curveToRelative(0.04f, -0.04f, 0.07f, -0.07f, 0.11f, -0.1f)
