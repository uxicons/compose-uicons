...
val Icons.Rr.SwipeRight: ImageVector
    get() = _SwipeRight ?: UXIcon(name = "SwipeRight") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(17.98f, 10.38f)
                ...
                horizontalLineToRelative(-6.8f)
                curveToRelative(-1.56f, 0f, -3.04f, -0.6f, -4.17f, -1.68f)
                ...
                curveToRelative(0.25f, 0f, 0.5f, 0.1f, 0.74f, 0.32f)
                lineToRelative(2.64f, 2.1f)
                curveToRelative(0.3f, 0.24f, 0.71f, 0.29f, 1.06f, 0.12f)
                curveToRelative(0.35f, -0.17f, 0.56f, -0.52f, 0.56f, -0.9f)
                lineTo(8.0f, 3f)
