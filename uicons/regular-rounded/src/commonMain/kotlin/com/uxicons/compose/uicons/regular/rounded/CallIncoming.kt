...
val Icons.Rr.CallIncoming: ImageVector
    get() = _CallIncoming ?: UXIcon(name = "CallIncoming") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(16.98f, 5.63f)
                curveTo(17.61f, 5f, 21.68f, 0.91f, 22.27f, 0.32f)
                arcTo(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = true, 23.69f, 1.73f)
                curveToRelative(-0.59f, 0.59f, -4.64f, 4.67f, -5.27f, 5.29f)
                lineTo(20.98f, 7.02f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, 2f)
                horizontalLineToRelative(-4f)
                arcTo(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = true, 14.98f, 7.02f)
                close()
                ...
                arcToRelative(3.11f, 3.11f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.01f, 4.28f)
                lineTo(7.96f, 9.11f)
                ...
                arcTo(15.01f, 15.01f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.88f, 9.32f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.14f, -1f)
                reflectiveCurveTo(7.63f, 6.3f, 7.66f, 6.28f)
