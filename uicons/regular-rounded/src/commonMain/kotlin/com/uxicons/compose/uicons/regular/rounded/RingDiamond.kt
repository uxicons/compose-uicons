...
val Icons.Rr.RingDiamond: ImageVector
    get() = _RingDiamond ?: UXIcon(name = "RingDiamond") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(8.97f, 3.22f)
                lineToRelative(1.32f, -1.22f)
                horizontalLineToRelative(3.42f)
                lineToRelative(1.3f, 1.17f)
                lineToRelative(-2.27f, 2.87f)
                curveToRelative(-0.25f, -0.02f, -0.49f, -0.04f, -0.75f, -0.04f)
                curveToRelative(-0.25f, 0f, -0.5f, 0.02f, -0.75f, 0.04f)
                lineToRelative(-2.28f, -2.82f)
                close()
                moveTo(12f, 22f)
