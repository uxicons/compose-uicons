...
val Icons.Rr.WindWarning: ImageVector
    get() = _WindWarning ?: UXIcon(name = "WindWarning") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(7f, 14f)
                curveTo(-2.25f, 13.71f, -2.25f, 0.29f, 7f, 0f)
                curveTo(16.25f, 0.29f, 16.25f, 13.71f, 7f, 14f)
                close()
                moveTo(7f, 2f)
                curveTo(0.39f, 2.21f, 0.39f, 11.79f, 7f, 12f)
                curveTo(13.61f, 11.79f, 13.61f, 2.21f, 7f, 2f)
                close()
                moveTo(20f, 9f)
                lineTo(17f, 9f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, -2f)
