...
val Icons.Rr.LightbulbSlash: ImageVector
    get() = _LightbulbSlash ?: UXIcon(name = "LightbulbSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-2.03f, 0f, -3.69f, -1.66f, -3.69f, -3.69f)
                ...
                curveToRelative(0f, 1.96f, 0.79f, 3.78f, 2.23f, 5.12f)
                ...
                horizontalLineToRelative(0.62f)
                curveToRelative(0.77f, 0f, 1.44f, -0.52f, 1.63f, -1.26f)
