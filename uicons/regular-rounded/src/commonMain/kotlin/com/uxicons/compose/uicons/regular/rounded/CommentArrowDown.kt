...
val Icons.Rr.CommentArrowDown: ImageVector
    get() = _CommentArrowDown ?: UXIcon(name = "CommentArrowDown") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(16.71f, 13.17f)
                curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0f, 1.41f)
                lineToRelative(-2.54f, 2.54f)
                curveToRelative(-0.58f, 0.58f, -1.41f, 0.88f, -2.17f, 0.88f)
                reflectiveCurveToRelative(-1.51f, -0.32f, -2.07f, -0.88f)
