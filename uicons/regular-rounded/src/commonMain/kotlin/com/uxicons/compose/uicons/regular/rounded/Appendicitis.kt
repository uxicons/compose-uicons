...
val Icons.Rr.Appendicitis: ImageVector
    get() = _Appendicitis ?: UXIcon(name = "Appendicitis") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-1.16f, 0.15f, -3.02f, 0.34f, -5f, 0.34f)
                reflectiveCurveToRelative(-3.83f, -0.18f, -5f, -0.33f)
                verticalLineToRelative(1.33f)
                curveToRelative(0f, 0.55f, -0.45f, 1f, -1f, 1f)
                reflectiveCurveToRelative(-1f, -0.45f, -1f, -1f)
                verticalLineToRelative(-1.87f)
                curveToRelative(-0.02f, -0.9f, 0.85f, -1.67f, 1.74f, -1.52f)
                curveToRelative(1.02f, 0.14f, 3.06f, 0.39f, 5.26f, 0.39f)
                reflectiveCurveToRelative(4.24f, -0.25f, 5.25f, -0.4f)
                curveToRelative(0.89f, -0.15f, 1.77f, 0.61f, 1.75f, 1.52f)
