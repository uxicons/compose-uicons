...
val Icons.Rr.TransformerBolt: ImageVector
    get() = _TransformerBolt ?: UXIcon(name = "TransformerBolt") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.02f, -0.07f, 2.45f, -4.41f, 2.45f, -4.41f)
