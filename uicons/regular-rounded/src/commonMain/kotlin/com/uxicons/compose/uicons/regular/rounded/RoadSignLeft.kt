...
val Icons.Rr.RoadSignLeft: ImageVector
    get() = _RoadSignLeft ?: UXIcon(name = "RoadSignLeft") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, -1.34f, -0.52f, -2.61f, -1.48f, -3.56f)
                close()
                moveTo(21.11f, 14.14f)
                lineToRelative(-6.97f, 6.97f)
                curveToRelative(-0.57f, 0.57f, -1.34f, 0.89f, -2.15f, 0.89f)
                reflectiveCurveToRelative(-1.57f, -0.32f, -2.15f, -0.89f)
                lineToRelative(-6.97f, -6.97f)
                curveToRelative(-0.57f, -0.57f, -0.89f, -1.34f, -0.89f, -2.15f)
                reflectiveCurveToRelative(0.32f, -1.57f, 0.89f, -2.15f)
                lineToRelative(6.97f, -6.96f)
                curveToRelative(0.57f, -0.57f, 1.33f, -0.88f, 2.15f, -0.88f)
                reflectiveCurveToRelative(1.58f, 0.31f, 2.15f, 0.88f)
                lineToRelative(6.97f, 6.97f)
                curveToRelative(0.57f, 0.57f, 0.89f, 1.34f, 0.89f, 2.15f)
                reflectiveCurveToRelative(-0.32f, 1.57f, -0.89f, 2.15f)
                close()
