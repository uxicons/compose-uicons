...
val Icons.Rr.TentArrowLeftRight: ImageVector
    get() = _TentArrowLeftRight ?: UXIcon(name = "TentArrowLeftRight") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(23.13f, 7.09f)
                ...
                lineToRelative(2.43f, 2.61f)
                curveToRelative(1.13f, 1.13f, 1.13f, 3.01f, -0.03f, 4.16f)
                close()
                moveTo(21.6f, 17.93f)
                curveToRelative(0.62f, 1.33f, 0.52f, 2.86f, -0.27f, 4.09f)
                curveToRelative(-0.79f, 1.24f, -2.14f, 1.98f, -3.6f, 1.98f)
                lineTo(6.28f, 24f)
                curveToRelative(-1.47f, 0f, -2.81f, -0.74f, -3.6f, -1.98f)
                curveToRelative(-0.79f, -1.23f, -0.89f, -2.76f, -0.27f, -4.09f)
                curveToRelative(0.02f, -0.05f, 5.85f, -8.67f, 5.87f, -8.7f)
                curveToRelative(1.2f, -1.39f, 2.05f, -2.24f, 3.73f, -2.24f)
