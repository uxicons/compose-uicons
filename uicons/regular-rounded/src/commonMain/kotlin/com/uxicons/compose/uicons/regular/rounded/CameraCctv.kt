...
val Icons.Rr.CameraCctv: ImageVector
    get() = _CameraCctv ?: UXIcon(name = "CameraCctv") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(16.84f, 13.48f)
                curveToRelative(-0.52f, 0.15f, -1.07f, 0.08f, -1.53f, -0.18f)
                lineTo(5.01f, 7.29f)
                curveToRelative(-0.94f, -0.54f, -1.28f, -1.74f, -0.77f, -2.69f)
                lineToRelative(0.84f, -1.55f)
                curveToRelative(0.26f, -0.47f, 0.68f, -0.82f, 1.2f, -0.97f)
                curveToRelative(0.19f, -0.05f, 0.37f, -0.08f, 0.56f, -0.08f)
                curveToRelative(0.34f, 0f, 0.67f, 0.08f, 0.96f, 0.25f)
                lineToRelative(12.4f, 7.14f)
                lineToRelative(-0.14f, 0.1f)
                curveToRelative(-0.44f, 0.34f, -0.79f, 0.76f, -1.06f, 1.25f)
                lineToRelative(-0.97f, 1.77f)
                curveToRelative(-0.26f, 0.47f, -0.69f, 0.82f, -1.21f, 0.97f)
                close()
            }
        }.also { _CameraCctv = it}
