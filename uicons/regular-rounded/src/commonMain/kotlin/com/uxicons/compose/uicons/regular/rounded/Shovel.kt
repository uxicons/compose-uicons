...
val Icons.Rr.Shovel: ImageVector
    get() = _Shovel ?: UXIcon(name = "Shovel") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(23.71f, 5.79f)
                lineTo(18.21f, 0.29f)
                ...
                lineToRelative(1.61f, -1.61f)
                curveToRelative(0.24f, -0.24f, 0.55f, -0.35f, 0.85f, -0.35f)
                reflectiveCurveToRelative(0.62f, 0.12f, 0.85f, 0.35f)
                lineToRelative(1.19f, 1.19f)
