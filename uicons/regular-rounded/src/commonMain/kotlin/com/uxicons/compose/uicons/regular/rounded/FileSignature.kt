...
val Icons.Rr.FileSignature: ImageVector
    get() = _FileSignature ?: UXIcon(name = "FileSignature") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 0.32f, 0.1f, 0.67f, 0.29f, 0.99f)
                curveToRelative(-0.32f, 0.28f, -0.74f, 0.51f, -1.29f, 0.51f)
                curveToRelative(-0.44f, 0f, -0.88f, -0.13f, -1.3f, -0.34f)
                curveToRelative(0.81f, -1.16f, 1.3f, -2.55f, 1.3f, -3.66f)
                curveToRelative(0f, -1.65f, -1.35f, -3f, -3f, -3f)
                reflectiveCurveToRelative(-3f, 1.35f, -3f, 3f)
                curveToRelative(0f, 1.22f, 0.68f, 2.65f, 1.71f, 3.8f)
                curveToRelative(-0.24f, 0.13f, -0.48f, 0.2f, -0.71f, 0.2f)
                curveToRelative(-0.55f, 0f, -1f, 0.45f, -1f, 1f)
                reflectiveCurveToRelative(0.45f, 1f, 1f, 1f)
                curveToRelative(0.83f, 0f, 1.61f, -0.33f, 2.3f, -0.85f)
                curveToRelative(0.84f, 0.53f, 1.76f, 0.85f, 2.7f, 0.85f)
                curveToRelative(2.6f, 0f, 4f, -2.48f, 4f, -3.5f)
                close()
                moveTo(7.13f, 13.4f)
                curveToRelative(-0.68f, -0.79f, -1.13f, -1.72f, -1.13f, -2.4f)
                curveToRelative(0f, -0.55f, 0.45f, -1f, 1f, -1f)
                reflectiveCurveToRelative(1f, 0.45f, 1f, 1f)
                curveToRelative(0f, 0.72f, -0.35f, 1.63f, -0.87f, 2.4f)
                close()
                moveTo(9f, 21f)
                curveToRelative(0f, 0.55f, -0.45f, 1f, -1f, 1f)
                ...
                reflectiveCurveToRelative(-1f, -0.45f, -1f, -1f)
                verticalLineToRelative(-1.76f)
                curveToRelative(0f, -0.08f, 0f, -0.16f, -0.02f, -0.24f)
