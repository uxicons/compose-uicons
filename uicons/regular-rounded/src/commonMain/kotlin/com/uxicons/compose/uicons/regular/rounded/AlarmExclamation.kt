...
val Icons.Rr.AlarmExclamation: ImageVector
    get() = _AlarmExclamation ?: UXIcon(name = "AlarmExclamation") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(5.4f, 2.55f, 1f, 7.27f, 1f, 13f)
                curveToRelative(0f, 2.74f, 1.01f, 5.25f, 2.67f, 7.17f)
                curveToRelative(-0.85f, 0.45f, -1.67f, 1.32f, -1.67f, 2.83f)
                curveToRelative(0f, 0.55f, 0.45f, 1f, 1f, 1f)
                reflectiveCurveToRelative(1f, -0.45f, 1f, -1f)
                curveToRelative(0f, -1f, 0.86f, -1.19f, 1.11f, -1.23f)
                curveToRelative(0.07f, -0.01f, 0.14f, -0.02f, 0.2f, -0.04f)
                curveToRelative(1.85f, 1.42f, 4.17f, 2.27f, 6.69f, 2.27f)
                reflectiveCurveToRelative(4.83f, -0.85f, 6.69f, -2.27f)
                curveToRelative(0.06f, 0.02f, 0.12f, 0.04f, 0.19f, 0.04f)
                curveToRelative(0.26f, 0.04f, 1.12f, 0.23f, 1.12f, 1.23f)
                curveToRelative(0f, 0.55f, 0.45f, 1f, 1f, 1f)
                reflectiveCurveToRelative(1f, -0.45f, 1f, -1f)
                ...
                curveToRelative(2.68f, 0f, 4.79f, 1.98f, 4.79f, 4.5f)
                close()
                moveTo(1f, 5.5f)
                curveToRelative(-0.55f, 0f, -1f, -0.45f, -1f, -1f)
                curveTo(0f, 1.98f, 2.1f, 0f, 4.79f, 0f)
                curveToRelative(0.55f, 0f, 1f, 0.45f, 1f, 1f)
                reflectiveCurveToRelative(-0.45f, 1f, -1f, 1f)
