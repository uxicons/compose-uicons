...
val Icons.Rr.Ticket: ImageVector
    get() = _Ticket ?: UXIcon(name = "Ticket") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(18f, 22f)
                lineTo(15.86f, 21.94f)
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 8.13f, 22f)
                lineTo(6f, 22f)
                ...
                arcTo(4.01f, 4.01f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 5f)
                arcToRelative(4.07f, 4.07f, 0f, isMoreThanHalf = false, isPositiveArc = false, 3.89f, -3f)
                lineTo(16f, 2f)
