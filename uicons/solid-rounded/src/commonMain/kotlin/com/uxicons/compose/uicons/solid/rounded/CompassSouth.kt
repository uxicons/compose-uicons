...
val Icons.Sr.CompassSouth: ImageVector
    get() = _CompassSouth ?: UXIcon(name = "CompassSouth") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.06f, 0.1f, 3.36f, 6.33f, 3.36f, 6.33f)
                curveToRelative(0.44f, 0.89f, 1.33f, 1.44f, 2.32f, 1.44f)
                horizontalLineToRelative(0.01f)
                curveToRelative(0.99f, 0f, 1.88f, -0.55f, 2.31f, -1.4f)
