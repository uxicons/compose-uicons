...
val Icons.Sr.FlaskPotion: ImageVector
    get() = _FlaskPotion ?: UXIcon(name = "FlaskPotion") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.08f, 0.64f, 0.26f, 1.31f, 0.5f, 1.98f)
                curveToRelative(0.86f, 2.36f, 3.15f, 3.89f, 5.66f, 3.89f)
                horizontalLineToRelative(11.47f)
                curveToRelative(2.57f, 0f, 4.91f, -1.61f, 5.72f, -4.05f)
                curveToRelative(0.35f, -1.07f, 0.56f, -2.18f, 0.56f, -3.23f)
