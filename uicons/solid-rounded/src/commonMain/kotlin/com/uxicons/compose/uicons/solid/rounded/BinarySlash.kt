...
val Icons.Sr.BinarySlash: ImageVector
    get() = _BinarySlash ?: UXIcon(name = "BinarySlash") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(18.14f, 22.32f)
                curveToRelative(0.23f, 0.5f, 0f, 1.1f, -0.5f, 1.32f)
                curveToRelative(-0.52f, 0.23f, -1.07f, 0.35f, -1.64f, 0.35f)
                ...
                curveToRelative(0.29f, 0f, 0.56f, -0.06f, 0.82f, -0.18f)
                ...
                curveToRelative(0f, 0.97f, -0.35f, 1.89f, -0.97f, 2.61f)
                lineToRelative(3.63f, 3.63f)
                curveToRelative(0.43f, -0.15f, 0.88f, -0.24f, 1.34f, -0.24f)
                curveToRelative(2.21f, 0f, 4f, 1.79f, 4f, 4f)
                ...
                curveToRelative(0.25f, -0.34f, 0.4f, -0.75f, 0.4f, -1.18f)
                verticalLineToRelative(-3f)
                curveToRelative(0f, -1.1f, -0.9f, -2f, -2f, -2f)
