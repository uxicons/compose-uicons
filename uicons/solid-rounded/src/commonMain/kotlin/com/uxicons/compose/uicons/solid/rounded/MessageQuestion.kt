...
val Icons.Sr.MessageQuestion: ImageVector
    get() = _MessageQuestion ?: UXIcon(name = "MessageQuestion") {
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveToRelative(-0.67f, 1.5f, -1.5f, 1.5f)
                close()
                moveTo(13.68f, 11.63f)
                curveToRelative(-0.24f, 0.11f, -0.68f, 0.64f, -0.68f, 1.17f)
                verticalLineToRelative(0.2f)
                curveToRelative(0f, 0.55f, -0.45f, 1f, -1f, 1f)
                reflectiveCurveToRelative(-1f, -0.45f, -1f, -1f)
                verticalLineToRelative(-0.2f)
                curveToRelative(0f, -1.38f, 0.95f, -2.57f, 1.84f, -2.98f)
