...
val Icons.Sr.WifiXmark: ImageVector
    get() = _WifiXmark ?: UXIcon(name = "WifiXmark") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-1.15f, 0.61f, -2.23f, 1.36f, -3.2f, 2.23f)
                curveToRelative(-0.41f, 0.37f, -0.45f, 1f, -0.08f, 1.41f)
                curveToRelative(0.2f, 0.22f, 0.47f, 0.33f, 0.74f, 0.33f)
                curveToRelative(0.24f, 0f, 0.48f, -0.08f, 0.67f, -0.26f)
                curveToRelative(0.85f, -0.76f, 1.79f, -1.42f, 2.8f, -1.95f)
