...
val Icons.Sr.GiftBoxBenefits: ImageVector
    get() = _GiftBoxBenefits ?: UXIcon(name = "GiftBoxBenefits") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-1.22f, 0f, -2.32f, 0.77f, -2.74f, 1.91f)
                curveToRelative(-0.42f, 1.14f, -0.08f, 2.44f, 0.88f, 3.26f)
                lineToRelative(1.13f, 0.92f)
                lineToRelative(-0.46f, 1.47f)
                curveToRelative(-0.26f, 0.83f, -0.12f, 1.71f, 0.32f, 2.42f)
                close()
            }
