...
val Icons.Sr.Coconut: ImageVector
    get() = _Coconut ?: UXIcon(name = "Coconut") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(4.69f, 16.33f)
                ...
                curveTo(-1.41f, 15.74f, -0.11f, 9.49f, 4.69f, 4.69f)
                curveTo(9.51f, -0.13f, 15.78f, -1.43f, 19.09f, 1.67f)
