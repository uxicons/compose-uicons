...
val Icons.Sr.BicycleJourney: ImageVector
    get() = _BicycleJourney ?: UXIcon(name = "BicycleJourney") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(-1.1f, -2.02f)
                horizontalLineToRelative(0.81f)
                curveToRelative(0.55f, 0f, 1f, -0.45f, 1f, -1f)
                reflectiveCurveToRelative(-0.45f, -1f, -1f, -1f)
                horizontalLineToRelative(-1.37f)
                curveToRelative(-0.6f, 0f, -1.13f, 0.31f, -1.44f, 0.82f)
                curveToRelative(-0.3f, 0.51f, -0.32f, 1.13f, -0.03f, 1.65f)
                lineToRelative(0.07f, 0.13f)
                lineToRelative(-0.89f, 0.53f)
                lineToRelative(-0.69f, -1.16f)
                curveToRelative(-0.36f, -0.6f, -1.02f, -0.97f, -1.72f, -0.97f)
                ...
                curveToRelative(0f, -0.45f, -0.13f, -0.87f, -0.34f, -1.23f)
                lineToRelative(1.53f, -0.92f)
                lineToRelative(0.34f, 0.62f)
                curveToRelative(-0.33f, 0.42f, -0.53f, 0.95f, -0.53f, 1.52f)
