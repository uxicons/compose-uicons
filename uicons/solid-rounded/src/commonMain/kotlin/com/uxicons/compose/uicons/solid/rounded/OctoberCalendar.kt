...
val Icons.Sr.OctoberCalendar: ImageVector
    get() = _OctoberCalendar ?: UXIcon(name = "OctoberCalendar") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(24f, 16.84f)
                ...
                curveToRelative(-0.41f, -0.66f, -0.66f, -1.43f, -0.66f, -2.26f)
                verticalLineToRelative(-3.4f)
