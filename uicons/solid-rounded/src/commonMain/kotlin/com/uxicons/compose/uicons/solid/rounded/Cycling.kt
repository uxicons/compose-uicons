...
val Icons.Sr.Cycling: ImageVector
    get() = _Cycling ?: UXIcon(name = "Cycling") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.12f, -0.2f, -0.01f, -0.36f, 0.28f, -0.36f)
                ...
                lineToRelative(-0.82f, -0.53f)
                lineToRelative(2.31f, -4.08f)
                lineToRelative(1.58f, 0.72f)
