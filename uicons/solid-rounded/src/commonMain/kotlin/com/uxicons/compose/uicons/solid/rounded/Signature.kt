...
val Icons.Sr.Signature: ImageVector
    get() = _Signature ?: UXIcon(name = "Signature") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(1.64f, 14.78f, 0f, 10.24f, 0f, 7.5f)
                curveTo(0f, 4.57f, 2.54f, 2f, 5.43f, 2f)
                reflectiveCurveToRelative(5.57f, 2.62f, 5.57f, 5.5f)
                curveToRelative(0f, 2.69f, -1.65f, 7.29f, -4.29f, 10.61f)
                curveToRelative(1.08f, 1.15f, 2.22f, 1.89f, 3.29f, 1.89f)
                curveToRelative(1.17f, 0f, 2.19f, -0.42f, 3.02f, -1.06f)
                curveToRelative(-1.31f, -1.86f, -2.02f, -4.12f, -2.02f, -5.48f)
                curveToRelative(0f, -1.84f, 1.64f, -3.45f, 3.51f, -3.45f)
                reflectiveCurveToRelative(3.49f, 1.61f, 3.49f, 3.45f)
                curveToRelative(0f, 1.51f, -0.77f, 3.77f, -2.23f, 5.58f)
                curveToRelative(0.67f, 0.59f, 1.42f, 0.97f, 2.23f, 0.97f)
                curveToRelative(1.95f, 0f, 3.32f, -1.12f, 4.05f, -3.32f)
                ...
                curveToRelative(0f, -1.8f, -1.74f, -3.5f, -3.57f, -3.5f)
                reflectiveCurveToRelative(-3.43f, 1.67f, -3.43f, 3.5f)
                curveToRelative(0f, 2.39f, 1.47f, 6.2f, 3.41f, 8.99f)
                close()
                moveTo(14.45f, 17.46f)
                curveToRelative(1.02f, -1.4f, 1.55f, -3.05f, 1.55f, -4f)
                curveToRelative(0f, -0.73f, -0.74f, -1.45f, -1.49f, -1.45f)
                reflectiveCurveToRelative(-1.51f, 0.73f, -1.51f, 1.45f)
                curveToRelative(0f, 0.95f, 0.55f, 2.6f, 1.45f, 4f)
                close()
            }
        }.also { _Signature = it}
