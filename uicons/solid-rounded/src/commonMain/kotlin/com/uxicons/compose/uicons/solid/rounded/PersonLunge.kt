...
val Icons.Sr.PersonLunge: ImageVector
    get() = _PersonLunge ?: UXIcon(name = "PersonLunge") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.32f, -0.95f, 0.01f, -2.02f, 0.81f, -2.66f)
                lineToRelative(2.46f, -1.88f)
                curveToRelative(0.9f, -0.75f, 1.69f, -1.08f, 2.81f, -1.17f)
                horizontalLineToRelative(0.01f)
                curveToRelative(1.65f, 0f, 2.79f, 1.25f, 2.79f, 2.97f)
