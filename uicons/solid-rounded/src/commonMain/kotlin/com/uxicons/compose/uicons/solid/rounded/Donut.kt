...
val Icons.Sr.Donut: ImageVector
    get() = _Donut ?: UXIcon(name = "Donut") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(12.49f, 0.01f)
                curveTo(5.89f, -0.26f, 0.41f, 4.8f, 0f, 11.23f)
                curveToRelative(0.81f, 0.24f, 1.58f, 0.62f, 2.26f, 1.16f)
                ...
                curveToRelative(0f, -6.49f, -5.0f, -12.09f, -11.49f, -12.36f)
                close()
            }
        }.also { _Donut = it}
