...
val Icons.Sr.SortNumericDownAlt: ImageVector
    get() = _SortNumericDownAlt ?: UXIcon(name = "SortNumericDownAlt") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(22f, 3.5f)
                verticalLineToRelative(1.5f)
                curveToRelative(0f, 3.65f, -1.96f, 6f, -5f, 6f)
                curveToRelative(-0.55f, 0f, -1f, -0.45f, -1f, -1f)
                reflectiveCurveToRelative(0.45f, -1f, 1f, -1f)
                curveToRelative(1.71f, 0f, 2.46f, -1.11f, 2.77f, -2.24f)
                curveToRelative(-0.4f, 0.15f, -0.82f, 0.24f, -1.27f, 0.24f)
