...
val Icons.Sr.WeightLoss: ImageVector
    get() = _WeightLoss ?: UXIcon(name = "WeightLoss") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.44f, 0.93f, 0.67f, 1.95f, 0.67f, 3f)
                curveToRelative(0f, 2.21f, -1.79f, 4f, -4f, 4f)
                horizontalLineToRelative(-6.53f)
                lineToRelative(0.01f, -0.01f)
                curveToRelative(-1.94f, -0.16f, -3.47f, -1.79f, -3.47f, -3.77f)
                curveToRelative(0f, -1.15f, 0.28f, -2.24f, 0.75f, -3.21f)
