...
val Icons.Sr.Spade: ImageVector
    get() = _Spade ?: UXIcon(name = "Spade") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(23f, 13.5f)
                curveTo(23f, 8.36f, 16.02f, 2.38f, 13.88f, 0.66f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3.76f, 0f)
                curveTo(7.98f, 2.38f, 1f, 8.36f, 1f, 13.5f)
                ...
                curveTo(10.75f, 20.81f, 10.12f, 22f, 8f, 22f)
                horizontalLineTo(6f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, 2f)
                horizontalLineTo(18f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, -2f)
                horizontalLineTo(16f)
                curveToRelative(-2.12f, 0f, -2.75f, -1.19f, -2.93f, -3.66f)
