...
val Icons.Sr.AirConditioner: ImageVector
    get() = _AirConditioner ?: UXIcon(name = "AirConditioner") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(1.55f, 0.55f, 2.67f, 2.2f, 2.67f, 3.94f)
                close()
            }
