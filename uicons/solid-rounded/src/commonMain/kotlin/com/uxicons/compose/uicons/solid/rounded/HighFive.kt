...
val Icons.Sr.HighFive: ImageVector
    get() = _HighFive ?: UXIcon(name = "HighFive") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(-0.43f, 3.01f)
                curveToRelative(-0.08f, 0.55f, -0.58f, 0.93f, -1.13f, 0.85f)
                horizontalLineToRelative(0f)
                curveToRelative(-0.55f, -0.08f, -0.93f, -0.58f, -0.85f, -1.13f)
                lineToRelative(0.37f, -2.56f)
                lineToRelative(-3.44f, 1.28f)
                curveTo(0.78f, 13.53f, 0f, 14.65f, 0f, 15.9f)
                verticalLineToRelative(3.1f)
                curveTo(0f, 20.18f, 1.01f, 21.1f, 2.18f, 20.99f)
                lineToRelative(3.36f, -0.31f)
                ...
                lineToRelative(3.36f, 0.31f)
                curveToRelative(1.17f, 0.11f, 2.18f, -0.82f, 2.18f, -1.99f)
                verticalLineToRelative(-3.77f)
                curveToRelative(0f, -0.83f, -0.52f, -1.58f, -1.3f, -1.87f)
                lineToRelative(-4.09f, -1.53f)
                lineToRelative(0.37f, 2.56f)
