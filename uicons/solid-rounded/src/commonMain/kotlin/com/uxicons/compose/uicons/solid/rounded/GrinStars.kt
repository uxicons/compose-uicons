...
val Icons.Sr.GrinStars: ImageVector
    get() = _GrinStars ?: UXIcon(name = "GrinStars") {
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(0.73f, 0.73f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.05f, 7f)
                lineTo(6.73f, 7f)
                ...
                arcTo(0.71f, 0.71f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.47f, 10.93f)
                close()
                ...
                lineToRelative(0.52f, -1.61f)
                lineToRelative(-1.37f, -1f)
                arcTo(0.73f, 0.73f, 0f, isMoreThanHalf = false, isPositiveArc = true, 13.07f, 7f)
                horizontalLineToRelative(1.68f)
                lineToRelative(0.51f, -1.59f)
                arcToRelative(0.74f, 0.74f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.4f, 0f)
                lineTo(17.17f, 7f)
