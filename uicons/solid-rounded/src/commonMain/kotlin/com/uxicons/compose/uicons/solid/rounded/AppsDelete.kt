...
val Icons.Sr.AppsDelete: ImageVector
    get() = _AppsDelete ?: UXIcon(name = "AppsDelete", viewportWidth = 512f, viewportHeight = 512f) {
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-11.78f, 0f, -21.33f, 9.55f, -21.33f, 21.33f)
                reflectiveCurveTo(286.89f, 149.33f, 298.67f, 149.33f)
                close()
            }
        }.also { _AppsDelete = it}
