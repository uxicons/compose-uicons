...
val Icons.Sr.PersonWalkingWithCane: ImageVector
    get() = _PersonWalkingWithCane ?: UXIcon(name = "PersonWalkingWithCane") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.35f, 0f, -0.69f, -0.19f, -0.88f, -0.51f)
                ...
                curveToRelative(-1.14f, -0.74f, -1.82f, -2f, -1.82f, -3.36f)
                ...
                curveToRelative(1.69f, 0f, 3.26f, 0.85f, 4.18f, 2.26f)
                ...
                lineToRelative(-0.65f, 4f)
                curveToRelative(-0.09f, 0.55f, 0.28f, 1.06f, 0.83f, 1.15f)
                curveToRelative(0.05f, 0f, 0.11f, 0.01f, 0.16f, 0.01f)
