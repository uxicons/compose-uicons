...
val Icons.Rs.Podcast: ImageVector
    get() = _Podcast ?: UXIcon(name = "Podcast") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(13.24f, 18.29f)
                curveToRelative(-0.87f, -0.28f, -1.2f, -0.29f, -1.24f, -0.29f)
                curveToRelative(-0.04f, 0f, -0.36f, 0.01f, -1.22f, 0.28f)
                lineToRelative(0.83f, 3.72f)
                horizontalLineToRelative(0.85f)
                lineToRelative(0.79f, -3.71f)
                close()
                moveTo(12.0f, 14f)
