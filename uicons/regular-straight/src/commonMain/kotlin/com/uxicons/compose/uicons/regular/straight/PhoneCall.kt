...
val Icons.Rs.PhoneCall: ImageVector
    get() = _PhoneCall ?: UXIcon(name = "PhoneCall") {
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(3.9f, 3.9f, 0f, isMoreThanHalf = false, isPositiveArc = true, 16.5f, 22f)
                ...
                lineTo(22f, 10f)
                arcTo(8.01f, 8.01f, 0f, isMoreThanHalf = false, isPositiveArc = false, 14f, 2f)
                close()
                moveTo(14f, 6f)
                lineTo(14f, 4f)
                arcToRelative(6.01f, 6.01f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6f, 6f)
                lineTo(18f, 10f)
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 14f, 6f)
                close()
            }
        }.also { _PhoneCall = it}
