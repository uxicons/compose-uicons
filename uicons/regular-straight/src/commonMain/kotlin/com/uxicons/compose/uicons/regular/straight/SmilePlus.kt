...
val Icons.Rs.SmilePlus: ImageVector
    get() = _SmilePlus ?: UXIcon(name = "SmilePlus") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(1.33f, -1.49f)
                curveToRelative(0.01f, 0.01f, 1.09f, 0.95f, 2.33f, 0.95f)
                reflectiveCurveToRelative(2.33f, -0.94f, 2.34f, -0.95f)
                close()
            }
        }.also { _SmilePlus = it}
