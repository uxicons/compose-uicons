...
val Icons.Rs.FaceWeary: ImageVector
    get() = _FaceWeary ?: UXIcon(name = "FaceWeary") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.5f, 0.3f, 1.14f, 0.42f, 1.71f, 0.33f)
                ...
                curveToRelative(0.56f, 0.1f, 1.2f, -0.03f, 1.69f, -0.33f)
                lineToRelative(1.04f, 1.71f)
                close()
                moveTo(18f, 18.0f)
                reflectiveCurveToRelative(-3.01f, -1f, -6.01f, -1f)
                reflectiveCurveToRelative(-6f, 1.0f, -6f, 1f)
