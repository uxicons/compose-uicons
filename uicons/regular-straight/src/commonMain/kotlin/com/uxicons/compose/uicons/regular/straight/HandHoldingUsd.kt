...
val Icons.Rs.HandHoldingUsd: ImageVector
    get() = _HandHoldingUsd ?: UXIcon(name = "HandHoldingUsd") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(23.02f, 8.79f)
                curveToRelative(-0.59f, -0.54f, -1.36f, -0.81f, -2.17f, -0.78f)
                ...
                curveToRelative(0.27f, 0f, 0.53f, 0.08f, 0.73f, 0.26f)
