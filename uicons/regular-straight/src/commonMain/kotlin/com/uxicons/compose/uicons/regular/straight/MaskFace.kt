...
val Icons.Rs.MaskFace: ImageVector
    get() = _MaskFace ?: UXIcon(name = "MaskFace") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(18.29f, 18.29f)
                curveToRelative(-2.35f, 2.35f, -4.7f, 3.21f, -6.07f, 3.52f)
                lineTo(3.68f, 13.28f)
                lineToRelative(0.99f, -3.44f)
                curveToRelative(0.15f, -0.54f, 0.26f, -1.1f, 0.32f, -1.66f)
                curveToRelative(0.12f, -1.25f, 0.45f, -2.25f, 0.69f, -2.49f)
                horizontalLineToRelative(0f)
                curveToRelative(0.24f, -0.24f, 1.24f, -0.57f, 2.49f, -0.69f)
                curveToRelative(0.57f, -0.06f, 1.12f, -0.16f, 1.66f, -0.32f)
                lineToRelative(3.44f, -0.99f)
                lineToRelative(8.53f, 8.53f)
                curveToRelative(-0.32f, 1.38f, -1.18f, 3.73f, -3.52f, 6.07f)
                close()
                moveTo(15.12f, 8.95f)
