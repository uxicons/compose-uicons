...
val Icons.Rs.Dna: ImageVector
    get() = _Dna ?: UXIcon(name = "Dna") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(15.54f, 13.23f)
                curveToRelative(-0.59f, 0.41f, -1.18f, 0.8f, -1.76f, 1.19f)
                curveToRelative(0.72f, 0.51f, 1.41f, 1.03f, 2.06f, 1.58f)
                horizontalLineToRelative(-7.67f)
                curveToRelative(1.32f, -1.12f, 2.84f, -2.13f, 4.39f, -3.17f)
                curveToRelative(4.64f, -3.1f, 9.45f, -6.3f, 9.45f, -12.83f)
                horizontalLineToRelative(-2f)
                curveToRelative(0f, 0.71f, -0.07f, 1.38f, -0.2f, 2f)
                lineTo(4.2f, 2f)
                curveToRelative(-0.13f, -0.62f, -0.2f, -1.29f, -0.2f, -2f)
                horizontalLineToRelative(-2f)
