...
val Icons.Rs.HockeyPuck: ImageVector
    get() = _HockeyPuck ?: UXIcon(name = "HockeyPuck") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(2f, 13.19f)
                arcTo(13.8f, 13.8f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 17f)
                arcToRelative(13.8f, 13.8f, 0f, isMoreThanHalf = false, isPositiveArc = false, 10f, -3.81f)
                close()
            }
        }.also { _HockeyPuck = it}
