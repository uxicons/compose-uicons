...
val Icons.Rs.FaceHeadBandage: ImageVector
    get() = _FaceHeadBandage ?: UXIcon(name = "FaceHeadBandage") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(1f, -0.34f, 2.08f, -0.52f, 3.2f, -0.52f)
                curveToRelative(3.69f, 0f, 6.91f, 2f, 8.65f, 4.98f)
                close()
                moveTo(6.04f, 3.97f)
                curveToRelative(3.45f, 0.66f, 9.72f, 2.27f, 15.74f, 5.97f)
                curveToRelative(0.14f, 0.66f, 0.21f, 1.35f, 0.21f, 2.06f)
                curveToRelative(0f, 0.15f, 0f, 0.3f, -0.01f, 0.45f)
                curveTo(15f, 7.76f, 7.25f, 6.17f, 4.24f, 5.7f)
                ...
                curveToRelative(0f, 0.83f, 0.67f, 1.5f, 1.5f, 1.5f)
                curveToRelative(0.71f, 0f, 1.31f, -0.49f, 1.46f, -1.16f)
