...
val Icons.Rs.UserHairMullet: ImageVector
    get() = _UserHairMullet ?: UXIcon(name = "UserHairMullet") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.8f, 0f, -1.39f, -0.46f, -1.81f, -1.01f)
                curveToRelative(0.51f, -0.88f, 0.81f, -1.9f, 0.81f, -2.99f)
                curveToRelative(0f, -3.31f, -2.69f, -6f, -6f, -6f)
                reflectiveCurveToRelative(-6f, 2.69f, -6f, 6f)
                curveToRelative(0f, 1.1f, 0.3f, 2.13f, 0.82f, 3.02f)
                curveToRelative(-0.42f, 0.53f, -1.02f, 0.98f, -1.82f, 0.98f)
                close()
                moveTo(12f, 10f)
