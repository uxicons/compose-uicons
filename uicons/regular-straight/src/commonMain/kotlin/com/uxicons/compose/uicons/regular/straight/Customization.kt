...
val Icons.Rs.Customization: ImageVector
    get() = _Customization ?: UXIcon(name = "Customization") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(18.84f, 13.31f)
                lineToRelative(-3.54f, -0.94f)
                lineToRelative(-1.83f, 3.63f)
                lineToRelative(-0.86f, -0.15f)
                lineToRelative(-0.34f, -2.69f)
                lineTo(1.47f, 23.94f)
                lineTo(0.06f, 22.53f)
                lineToRelative(10.77f, -10.77f)
                lineToRelative(-2.67f, -0.34f)
