...
val Icons.Rs.RollerCoaster: ImageVector
    get() = _RollerCoaster ?: UXIcon(name = "RollerCoaster") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(3f, 24f)
                lineTo(3f, 10.99f)
                curveToRelative(0.57f, 0.76f, 1.25f, 1.44f, 2.01f, 2.01f)
                horizontalLineToRelative(-0.01f)
                verticalLineToRelative(11f)
                horizontalLineToRelative(2f)
                lineTo(7f, 14.16f)
                curveToRelative(0.64f, 0.28f, 1.3f, 0.49f, 2f, 0.64f)
                ...
                horizontalLineToRelative(2f)
                lineTo(15f, 14.16f)
                curveToRelative(0.34f, -0.15f, 0.68f, -0.32f, 1f, -0.51f)
                curveToRelative(0.32f, 0.19f, 0.66f, 0.36f, 1f, 0.51f)
                verticalLineToRelative(9.84f)
                horizontalLineToRelative(2f)
                lineTo(19f, 14.8f)
                curveToRelative(0.65f, 0.13f, 1.31f, 0.2f, 2f, 0.2f)
