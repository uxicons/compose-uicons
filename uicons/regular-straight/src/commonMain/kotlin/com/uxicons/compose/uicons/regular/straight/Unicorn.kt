...
val Icons.Rs.Unicorn: ImageVector
    get() = _Unicorn ?: UXIcon(name = "Unicorn") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(22.59f, 6.66f)
                curveToRelative(-1.22f, -0.58f, -2.12f, -1.38f, -2.72f, -2.37f)
                lineToRelative(-0.08f, -0.16f)
                lineToRelative(4.21f, -3.47f)
                ...
                curveToRelative(-2.39f, 0.86f, -4.88f, 2.82f, -4.88f, 8.5f)
