...
val Icons.Rs.PersonDrowning: ImageVector
    get() = _PersonDrowning ?: UXIcon(name = "PersonDrowning") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(4.45f, 1.25f)
                lineToRelative(-0.43f, 1.6f)
                horizontalLineToRelative(2.07f)
                lineToRelative(0.33f, -1.25f)
                lineToRelative(4.33f, -0.77f)
                lineToRelative(4.7f, -1.91f)
                lineToRelative(-0.76f, -1.85f)
                lineToRelative(-4.4f, 1.8f)
                lineToRelative(-4.21f, 0.75f)
                lineToRelative(-6.79f, -1.91f)
                lineToRelative(-2.55f, -2.87f)
                lineTo(2.52f, 0.02f)
                lineTo(0.86f, 1.13f)
                lineTo(3.55f, 5.17f)
                lineToRelative(2.96f, 3.35f)
                close()
            }
