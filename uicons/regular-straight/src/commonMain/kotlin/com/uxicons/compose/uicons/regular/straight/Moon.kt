...
val Icons.Rs.Moon: ImageVector
    get() = _Moon ?: UXIcon(name = "Moon") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(14f, 2f)
                arcTo(10.01f, 10.01f, 0f, isMoreThanHalf = false, isPositiveArc = false, 4f, 12f)
                curveToRelative(-0.15f, 7.12f, 7.76f, 12.2f, 14.15f, 9.08f)
                arcToRelative(11.54f, 11.54f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.88f, -18.52f)
                arcTo(9.74f, 9.74f, 0f, isMoreThanHalf = false, isPositiveArc = false, 14f, 2f)
                close()
            }
        }.also { _Moon = it}
