...
val Icons.Rs.CandyCane: ImageVector
    get() = _CandyCane ?: UXIcon(name = "CandyCane") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.45f, 0.73f, -1.03f, 1.71f, -1.77f, 3f)
                horizontalLineToRelative(-1.99f)
                curveToRelative(0.65f, -1.16f, 1.23f, -2.15f, 1.73f, -3f)
                close()
                moveTo(7.53f, 12f)
                ...
                horizontalLineToRelative(1.97f)
                curveToRelative(-1f, 1.82f, -1.9f, 3.43f, -2.42f, 4.36f)
                close()
                moveTo(13.82f, 4.92f)
                reflectiveCurveToRelative(-0.05f, 0.05f, -0.07f, 0.08f)
                horizontalLineToRelative(-2.13f)
                curveToRelative(0.39f, -0.59f, 0.7f, -1f, 0.94f, -1.26f)
