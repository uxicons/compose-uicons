...
val Icons.Rs.Bath: ImageVector
    get() = _Bath ?: UXIcon(name = "Bath") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(8.59f, 21f)
                curveToRelative(-3.09f, 0f, -5.71f, -2.31f, -6.09f, -5.38f)
                lineToRelative(-0.2f, -1.62f)
                horizontalLineToRelative(19.41f)
                lineToRelative(-0.2f, 1.62f)
                curveToRelative(-0.38f, 3.06f, -3.0f, 5.38f, -6.09f, 5.38f)
                horizontalLineToRelative(-6.83f)
                close()
            }
        }.also { _Bath = it}
