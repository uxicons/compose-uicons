...
private var _Rs90SMusicDisc: ImageVector? = null

val Icons.Rs.Rs90SMusicDisc: ImageVector
    get() = _Rs90SMusicDisc ?: UXIcon(name = "Rs90SMusicDisc") {
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveTo(2.55f, 18.07f, 2.05f, 13.02f)
                lineTo(6.09f, 13.02f)
                close()
                moveTo(8f, 6f)
