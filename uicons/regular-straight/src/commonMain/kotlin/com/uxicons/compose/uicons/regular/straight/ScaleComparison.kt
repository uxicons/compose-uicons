...
val Icons.Rs.ScaleComparison: ImageVector
    get() = _ScaleComparison ?: UXIcon(name = "ScaleComparison") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(10.71f, -2.04f)
                lineToRelative(-2.66f, 8.48f)
                lineToRelative(-0.05f, 1.8f)
                horizontalLineToRelative(8f)
                verticalLineToRelative(-1.5f)
                lineToRelative(-2.87f, -9.24f)
                lineToRelative(10.87f, -2.07f)
                verticalLineToRelative(-2.03f)
                close()
                moveTo(10.21f, 22.0f)
                lineToRelative(1.79f, -5.71f)
                lineToRelative(1.79f, 5.71f)
