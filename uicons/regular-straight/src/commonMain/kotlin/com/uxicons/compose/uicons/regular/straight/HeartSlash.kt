...
val Icons.Rs.HeartSlash: ImageVector
    get() = _HeartSlash ?: UXIcon(name = "HeartSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(4.84f, 3.42f)
                curveToRelative(0.53f, -0.21f, 1.08f, -0.33f, 1.66f, -0.33f)
                curveToRelative(2.4f, 0f, 4.5f, 2.34f, 4.5f, 5f)
                horizontalLineToRelative(2f)
                curveToRelative(0f, -2.66f, 2.1f, -5f, 4.5f, -5f)
                curveToRelative(2.48f, 0f, 4.5f, 2.02f, 4.5f, 4.5f)
                curveToRelative(0f, 2.33f, -1.6f, 5.23f, -4.6f, 8.39f)
                lineTo(4.84f, 3.42f)
                close()
                moveTo(14.51f, 18.75f)
                ...
                curveToRelative(-0.1f, 0.38f, -0.16f, 0.78f, -0.16f, 1.19f)
                curveToRelative(0f, 4.28f, 5.26f, 9.66f, 10.0f, 13.17f)
                curveToRelative(0.63f, -0.47f, 1.52f, -1.16f, 2.51f, -2.01f)
                close()
            }
        }.also { _HeartSlash = it}
