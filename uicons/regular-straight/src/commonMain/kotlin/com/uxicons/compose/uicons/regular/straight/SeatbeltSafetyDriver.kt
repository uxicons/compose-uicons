...
val Icons.Rs.SeatbeltSafetyDriver: ImageVector
    get() = _SeatbeltSafetyDriver ?: UXIcon(name = "SeatbeltSafetyDriver") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(1.37f, -0.53f, 3.35f, -1.07f, 5.7f, -1.07f)
                curveToRelative(1.01f, 0f, 2.03f, 0.12f, 3f, 0.32f)
                verticalLineToRelative(-4.24f)
                lineToRelative(2f, -1.76f)
