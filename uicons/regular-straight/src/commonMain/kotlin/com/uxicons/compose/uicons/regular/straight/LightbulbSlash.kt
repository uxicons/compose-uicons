...
val Icons.Rs.LightbulbSlash: ImageVector
    get() = _LightbulbSlash ?: UXIcon(name = "LightbulbSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveToRelative(0f, -0.05f, 0f, -0.07f)
                ...
                curveToRelative(0f, -0.05f, 0f, -0.1f, 0f, -0.15f)
                horizontalLineToRelative(4.03f)
                curveToRelative(0f, 0.11f, -0.02f, 0.21f, -0.02f, 0.31f)
                close()
            }
