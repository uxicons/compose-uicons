...
val Icons.Rs.EyeLashes: ImageVector
    get() = _EyeLashes ?: UXIcon(name = "EyeLashes") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(23.82f, 13.18f)
                ...
                curveToRelative(-0.63f, -0.47f, -1.32f, -0.9f, -2.1f, -1.27f)
                ...
                lineToRelative(-1.56f, 1.25f)
                lineToRelative(2.68f, 3.35f)
                curveToRelative(-1.7f, 1.72f, -2.69f, 3.58f, -3.1f, 4.48f)
                ...
                close()
                moveTo(12f, 21f)
                curveToRelative(-6.3f, 0f, -9.25f, -5.37f, -10.0f, -6.99f)
                curveToRelative(0.75f, -1.65f, 3.7f, -7.01f, 10.0f, -7.01f)
                reflectiveCurveToRelative(9.25f, 5.37f, 10.0f, 6.99f)
                curveToRelative(-0.75f, 1.65f, -3.7f, 7.01f, -10.0f, 7.01f)
                close()
                moveTo(12f, 9f)
