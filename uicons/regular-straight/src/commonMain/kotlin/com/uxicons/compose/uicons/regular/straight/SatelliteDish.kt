...
val Icons.Rs.SatelliteDish: ImageVector
    get() = _SatelliteDish ?: UXIcon(name = "SatelliteDish") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(-1.51f, 1.51f)
                close()
                moveTo(14.54f, 20.38f)
                lineTo(3.62f, 9.46f)
                curveToRelative(-2.35f, 3.05f, -2.13f, 7.46f, 0.66f, 10.26f)
                curveToRelative(2.8f, 2.8f, 7.21f, 3.02f, 10.26f, 0.66f)
                close()
            }
