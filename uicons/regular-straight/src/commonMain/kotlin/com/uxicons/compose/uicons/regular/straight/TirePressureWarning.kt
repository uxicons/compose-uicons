...
val Icons.Rs.TirePressureWarning: ImageVector
    get() = _TirePressureWarning ?: UXIcon(name = "TirePressureWarning") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(23.73f, 10.41f, 21.96f, 17.29f, 17.7f, 20f)
                lineTo(6.3f, 20f)
                curveTo(2.01f, 17.27f, 0.28f, 10.4f, 4.21f, 5.27f)
                ...
                curveTo(-1.96f, 10.04f, -0.1f, 18.09f, 5f, 21.53f)
                lineTo(5f, 24f)
                lineTo(7f, 24f)
                lineTo(7f, 22f)
                lineTo(9f, 22f)
