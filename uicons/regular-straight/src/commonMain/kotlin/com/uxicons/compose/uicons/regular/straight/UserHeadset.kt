...
val Icons.Rs.UserHeadset: ImageVector
    get() = _UserHeadset ?: UXIcon(name = "UserHeadset") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(12.82f, 6.09f)
                curveToRelative(1.25f, 0.29f, 2.28f, 1.3f, 2.58f, 2.56f)
                curveToRelative(0.2f, 0.85f, 0.09f, 1.66f, -0.24f, 2.35f)
                ...
                curveToRelative(0.04f, -0.85f, 0.35f, -1.63f, 0.84f, -2.26f)
                curveToRelative(-0.23f, -0.46f, -0.36f, -0.99f, -0.36f, -1.54f)
                curveToRelative(0f, -2.2f, 2.04f, -3.93f, 4.32f, -3.4f)
                close()
                moveTo(6.87f, 4.03f)
                ...
                curveToRelative(-0.24f, -0.83f, -1.01f, -1.44f, -1.92f, -1.44f)
                curveToRelative(-1.1f, 0f, -2f, 0.9f, -2f, 2f)
                reflectiveCurveToRelative(0.9f, 2f, 2f, 2f)
                curveToRelative(0.54f, 0f, 1.03f, -0.21f, 1.39f, -0.56f)
