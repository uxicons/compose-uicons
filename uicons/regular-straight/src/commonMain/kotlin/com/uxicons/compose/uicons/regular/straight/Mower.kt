...
val Icons.Rs.Mower: ImageVector
    get() = _Mower ?: UXIcon(name = "Mower") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(13.95f, 16.68f)
                lineToRelative(-0.49f, 1.28f)
                curveToRelative(0.01f, 0.01f, 0.02f, 0.02f, 0.03f, 0.03f)
                horizontalLineToRelative(6.02f)
                curveToRelative(0.16f, -0.21f, 0.35f, -0.4f, 0.57f, -0.56f)
                lineToRelative(-0.36f, -1.45f)
