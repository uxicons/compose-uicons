...
val Icons.Rs.Cycling: ImageVector
    get() = _Cycling ?: UXIcon(name = "Cycling") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.14f, -0.24f, 0.01f, -0.36f, 0.27f, -0.36f)
                ...
                lineToRelative(-2.91f, -1.87f)
                curveToRelative(-0.55f, -0.24f, -0.76f, -0.94f, -0.42f, -1.46f)
                lineToRelative(1.2f, -2.13f)
                curveToRelative(0.27f, -0.47f, 0.88f, -0.63f, 1.42f, -0.34f)
                lineToRelative(2.87f, 1.32f)
                curveToRelative(-0.24f, 0.38f, -0.35f, 1.01f, -0.07f, 1.56f)
