...
val Icons.Rs.Signature: ImageVector
    get() = _Signature ?: UXIcon(name = "Signature") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(1.41f, 0f, 2.79f, -0.79f, 4.03f, -2f)
                curveTo(1.62f, 14.74f, 0f, 10.23f, 0f, 7.5f)
                ...
                curveToRelative(0f, 2.38f, 1.46f, 6.17f, 3.39f, 8.95f)
                close()
