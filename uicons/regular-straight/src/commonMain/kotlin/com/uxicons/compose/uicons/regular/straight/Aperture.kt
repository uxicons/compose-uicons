...
val Icons.Rs.Aperture: ImageVector
    get() = _Aperture ?: UXIcon(name = "Aperture") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(11.1f, 2.04f)
                lineToRelative(-4.78f, 7.84f)
                lineToRelative(-2.24f, -3.98f)
                curveToRelative(1.66f, -2.15f, 4.17f, -3.61f, 7.02f, -3.86f)
                close()
                moveTo(2.84f, 16f)
                curveToRelative(-0.54f, -1.23f, -0.84f, -2.58f, -0.84f, -4f)
                curveToRelative(0f, -1.47f, 0.32f, -2.87f, 0.89f, -4.13f)
                lineToRelative(4.58f, 8.13f)
                lineTo(2.84f, 16f)
                close()
                moveTo(10.59f, 21.9f)
                curveToRelative(-2.68f, -0.38f, -5.03f, -1.83f, -6.59f, -3.9f)
