...
val Icons.Bs.CalendarGavelLegal: ImageVector
    get() = _CalendarGavelLegal ?: UXIcon(name = "CalendarGavelLegal") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(17.19f, 19.31f)
