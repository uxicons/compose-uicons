...
val Icons.Bs.CoffeeBeans: ImageVector
    get() = _CoffeeBeans ?: UXIcon(name = "CoffeeBeans") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(17.1f, 12.22f)
                curveToRelative(0.22f, 0.7f, 0.37f, 1.95f, -0.45f, 3.63f)
                curveToRelative(-0.65f, 1.34f, -0.9f, 2.53f, -0.92f, 3.56f)
                curveToRelative(-0.45f, -0.79f, -0.73f, -1.81f, -0.73f, -2.9f)
                curveToRelative(0f, -1.97f, 0.9f, -3.69f, 2.1f, -4.28f)
                close()
                moveTo(18.9f, 20.78f)
                curveToRelative(-0.22f, -0.7f, -0.37f, -1.95f, 0.45f, -3.63f)
                curveToRelative(0.65f, -1.34f, 0.9f, -2.53f, 0.92f, -3.56f)
                ...
                curveToRelative(0.31f, 0f, 0.67f, 0.04f, 1.02f, 0.17f)
                curveToRelative(-0.34f, 0.69f, -1.15f, 1.76f, -3.05f, 2.42f)
                curveToRelative(-1.54f, 0.53f, -2.63f, 1.28f, -3.4f, 2.05f)
                curveToRelative(0.22f, -0.98f, 0.79f, -2.01f, 1.65f, -2.88f)
                curveToRelative(0.93f, -0.93f, 2.11f, -1.56f, 3.23f, -1.72f)
                close()
                moveTo(6.01f, 10.96f)
                curveToRelative(-0.38f, 0.05f, -0.99f, 0.08f, -1.57f, -0.13f)
