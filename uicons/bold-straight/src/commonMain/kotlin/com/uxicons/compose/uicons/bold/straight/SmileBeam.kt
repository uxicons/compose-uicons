...
val Icons.Bs.SmileBeam: ImageVector
    get() = _SmileBeam ?: UXIcon(name = "SmileBeam") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(15.51f, 13.58f)
                lineTo(17.5f, 15.82f)
                arcToRelative(8.14f, 8.14f, 0f, isMoreThanHalf = false, isPositiveArc = true, -11f, 0f)
                lineToRelative(2f, -2.24f)
                arcTo(5.13f, 5.13f, 0f, isMoreThanHalf = false, isPositiveArc = false, 15.51f, 13.58f)
                close()
                moveTo(24f, 12f)
