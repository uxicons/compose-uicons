...
val Icons.Bs.BenefitDiamondAlt: ImageVector
    get() = _BenefitDiamondAlt ?: UXIcon(name = "BenefitDiamondAlt") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.33f, -0.32f, -0.85f, -0.32f, -1.18f, 0f)
                ...
                curveToRelative(1.26f, -0.27f, 2.63f, 0.11f, 3.62f, 1.1f)
                lineToRelative(3.38f, 3.38f)
                lineToRelative(3.46f, -3.46f)
                curveToRelative(0.96f, -0.96f, 2.3f, -1.29f, 3.54f, -1.02f)
                verticalLineToRelative(-3.46f)
