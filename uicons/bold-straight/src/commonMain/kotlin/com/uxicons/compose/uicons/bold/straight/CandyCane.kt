...
val Icons.Bs.CandyCane: ImageVector
    get() = _CandyCane ?: UXIcon(name = "CandyCane") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.36f, 0.66f, -0.72f, 1.34f, -1.08f, 2f)
                ...
                close()
                moveTo(8.99f, 10f)
                curveToRelative(0.42f, -0.74f, 0.81f, -1.4f, 1.16f, -2f)
                horizontalLineToRelative(3.01f)
                curveToRelative(-0.31f, 0.55f, -0.68f, 1.23f, -1.1f, 2f)
                ...
                curveToRelative(0f, -0.43f, -0.12f, -0.83f, -0.33f, -1.19f)
