...
val Icons.Bs.CanFood: ImageVector
    get() = _CanFood ?: UXIcon(name = "CanFood") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(12f, 0f)
                curveTo(6.48f, 0f, 2f, 1.34f, 2f, 3f)
                ...
                reflectiveCurveToRelative(-6.39f, -0.81f, -7f, -1.3f)
                verticalLineToRelative(-1.56f)
                ...
                reflectiveCurveToRelative(5.04f, -0.29f, 7f, -1.0f)
                verticalLineToRelative(4.7f)
                close()
                moveTo(12f, 21f)
