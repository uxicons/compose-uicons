...
val Icons.Bs.GuaraniSign: ImageVector
    get() = _GuaraniSign ?: UXIcon(name = "GuaraniSign") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(10.49f, 1.1f)
                curveTo(5.15f, 1.84f, 1.01f, 6.45f, 1.01f, 12f)
                ...
                close()
                moveTo(4.01f, 12f)
                curveToRelative(0f, -3.89f, 2.8f, -7.15f, 6.49f, -7.86f)
                ...
                horizontalLineToRelative(5.99f)
                curveToRelative(0.24f, 0f, 0.38f, 0.16f, 0.42f, 0.22f)
