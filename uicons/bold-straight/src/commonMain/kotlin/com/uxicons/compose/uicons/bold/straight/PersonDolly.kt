...
val Icons.Bs.PersonDolly: ImageVector
    get() = _PersonDolly ?: UXIcon(name = "PersonDolly") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(16.39f, 14.71f)
                curveToRelative(0.19f, 0.81f, 1f, 1.31f, 1.81f, 1.12f)
                lineToRelative(2.74f, -0.65f)
                curveToRelative(0.8f, -0.19f, 1.3f, -1.0f, 1.11f, -1.8f)
                lineToRelative(-0.66f, -2.81f)
                curveToRelative(-0.19f, -0.81f, -1f, -1.31f, -1.81f, -1.12f)
                lineToRelative(-2.74f, 0.65f)
                curveToRelative(-0.8f, 0.19f, -1.3f, 1.0f, -1.11f, 1.8f)
                lineToRelative(0.66f, 2.81f)
