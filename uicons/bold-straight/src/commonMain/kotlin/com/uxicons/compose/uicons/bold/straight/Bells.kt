...
val Icons.Bs.Bells: ImageVector
    get() = _Bells ?: UXIcon(name = "Bells") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-4.05f, 0f, -7.49f, 2.74f, -8.37f, 6.69f)
                ...
                reflectiveCurveToRelative(3.21f, -1.31f, 3.45f, -3f)
                horizontalLineToRelative(3.35f)
                curveToRelative(0.93f, 0f, 1.79f, -0.39f, 2.39f, -1.07f)
                ...
                lineTo(7.2f, 18f)
                curveToRelative(-0.07f, 0f, -0.12f, -0.02f, -0.16f, -0.07f)
                curveToRelative(-0.04f, -0.05f, -0.05f, -0.1f, -0.03f, -0.17f)
                lineToRelative(1.55f, -7.43f)
                curveToRelative(0.57f, -2.55f, 2.81f, -4.33f, 5.44f, -4.33f)
                curveToRelative(2.5f, 0f, 4.7f, 1.66f, 5.35f, 3.95f)
                lineToRelative(1.65f, 7.82f)
                curveToRelative(0.01f, 0.05f, 0f, 0.1f, -0.02f, 0.15f)
                close()
                moveTo(5.26f, 5.61f)
                ...
                lineTo(1.62f, 6.69f)
                curveTo(2.51f, 2.74f, 5.95f, 0f, 10f, 0f)
                curveToRelative(1.43f, 0f, 2.81f, 0.36f, 4.02f, 1f)
                curveToRelative(0f, 0f, -0.01f, 0f, -0.02f, 0f)
                curveToRelative(-3.26f, 0f, -6.2f, 1.46f, -8.15f, 3.83f)
