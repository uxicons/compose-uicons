...
val Icons.Bs.PhoneFlip: ImageVector
    get() = _PhoneFlip ?: UXIcon(name = "PhoneFlip") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(7.15f, 0f, 15.94f, -8.79f, 15.94f, -15.94f)
                curveToRelative(0f, -1.65f, -0.63f, -3.19f, -1.76f, -4.32f)
                close()
                moveTo(8.06f, 21f)
                curveToRelative(-0.85f, 0f, -1.63f, -0.31f, -2.2f, -0.89f)
