...
val Icons.Bs.CircleWifiCircleWifi: ImageVector
    get() = _CircleWifiCircleWifi ?: UXIcon(name = "CircleWifiCircleWifi") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(10.0f, 18.0f)
                curveToRelative(0f, 1.06f, 0.21f, 2.07f, 0.58f, 3.0f)
