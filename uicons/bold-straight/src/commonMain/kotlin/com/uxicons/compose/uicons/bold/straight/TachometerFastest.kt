...
val Icons.Bs.TachometerFastest: ImageVector
    get() = _TachometerFastest ?: UXIcon(name = "TachometerFastest") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(17.22f, 16.88f)
                lineTo(18.41f, 14.12f)
                lineTo(13.81f, 12.14f)
                arcTo(2f, 2f, 0f, isMoreThanHalf = true, isPositiveArc = false, 12.62f, 14.9f)
                close()
            }
