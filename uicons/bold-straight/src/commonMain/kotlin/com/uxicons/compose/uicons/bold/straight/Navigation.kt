...
val Icons.Bs.Navigation: ImageVector
    get() = _Navigation ?: UXIcon(name = "Navigation") {
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(6.73f, 10.08f)
                lineTo(16.5f, 7.5f)
                lineToRelative(-2.55f, 9.77f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.92f, 0.01f)
                lineTo(10.5f, 13.5f)
                lineTo(6.72f, 12f)
                arcTo(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6.73f, 10.08f)
                close()
            }
        }.also { _Navigation = it}
