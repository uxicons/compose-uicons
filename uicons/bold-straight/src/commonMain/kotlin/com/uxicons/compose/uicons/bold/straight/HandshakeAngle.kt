...
val Icons.Bs.HandshakeAngle: ImageVector
    get() = _HandshakeAngle ?: UXIcon(name = "HandshakeAngle") {
            path(fill = SolidColor(Color.Black)) {
                ...
                verticalLineTo(7.5f)
                curveToRelative(0f, -1.14f, 0.77f, -2.14f, 1.92f, -2.43f)
                ...
                reflectiveCurveToRelative(3.99f, -1.79f, 4f, -3.99f)
                ...
                curveToRelative(2.44f, -0.01f, 4.61f, -1.66f, 5.27f, -4f)
