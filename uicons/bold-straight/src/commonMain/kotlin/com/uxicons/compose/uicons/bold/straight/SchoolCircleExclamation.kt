...
val Icons.Bs.SchoolCircleExclamation: ImageVector
    get() = _SchoolCircleExclamation ?: UXIcon(name = "SchoolCircleExclamation") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(3.09f, 3.34f)
                curveToRelative(0.9f, -0.35f, 1.88f, -0.56f, 2.91f, -0.56f)
                curveToRelative(0.23f, 0f, 0.46f, 0.01f, 0.69f, 0.04f)
