...
private var _90S: ImageVector? = null

val Icons.Bs.NinetyS: ImageVector
    get() = _90S ?: UXIcon(name = "90S") {
        path(fill = SolidColor(Color.Black)) {
            moveToRelative(13f, 6.02f)
            ...
            curveToRelative(0f, 0.95f, -0.77f, 1.5f, -1.72f, 1.5f)
