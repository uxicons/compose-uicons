...
val Icons.Bs.SignatureSlash: ImageVector
    get() = _SignatureSlash ?: UXIcon(name = "SignatureSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-1.94f, 0f, -3.68f, -0.98f, -5.16f, -2.45f)
                curveToRelative(-1.56f, 1.47f, -3.37f, 2.45f, -5.34f, 2.45f)
                verticalLineToRelative(-3f)
                curveToRelative(1.17f, 0f, 2.36f, -0.71f, 3.44f, -1.79f)
                curveTo(1.26f, 13.93f, 0f, 9.79f, 0f, 7.5f)
                curveToRelative(0f, -0.74f, 0.15f, -1.46f, 0.43f, -2.12f)
                ...
                curveToRelative(1f, 1.05f, 2.1f, 1.73f, 3.19f, 1.73f)
                curveToRelative(0.8f, 0f, 1.52f, -0.21f, 2.17f, -0.53f)
                ...
                curveToRelative(0f, 0.4f, -0.03f, 0.82f, -0.1f, 1.28f)
