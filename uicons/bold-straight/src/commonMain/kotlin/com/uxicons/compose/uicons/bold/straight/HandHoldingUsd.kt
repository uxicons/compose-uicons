...
val Icons.Bs.HandHoldingUsd: ImageVector
    get() = _HandHoldingUsd ?: UXIcon(name = "HandHoldingUsd") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 0.32f, -0.24f, 0.59f, -0.55f, 0.63f)
                ...
                curveToRelative(0.36f, 0.33f, 0.38f, 0.88f, 0.05f, 1.25f)
                close()
            }
