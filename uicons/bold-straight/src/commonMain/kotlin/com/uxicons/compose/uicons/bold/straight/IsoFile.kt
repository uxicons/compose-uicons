...
val Icons.Bs.IsoFile: ImageVector
    get() = _IsoFile ?: UXIcon(name = "IsoFile") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.0f, 1.72f, 0.01f, 4.67f, 0.01f, 6f)
                horizontalLineToRelative(-1.25f)
                close()
                moveTo(9.21f, 20.09f)
                ...
                curveToRelative(0.1f, -0.77f, 0.81f, -1.39f, 1.6f, -1.45f)
                ...
                curveToRelative(-0.81f, -0.01f, -1.58f, -0.34f, -2.1f, -0.91f)
                close()
                moveTo(14.5f, 19.03f)
                lineTo(14.49f, 16.97f)
