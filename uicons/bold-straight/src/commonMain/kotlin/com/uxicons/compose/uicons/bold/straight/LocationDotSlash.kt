...
val Icons.Bs.LocationDotSlash: ImageVector
    get() = _LocationDotSlash ?: UXIcon(name = "LocationDotSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.5f, -0.53f, 0.81f, -1.25f, 0.81f, -2.04f)
                curveToRelative(0f, -1.64f, -1.33f, -2.98f, -2.98f, -2.98f)
                curveToRelative(-0.79f, 0f, -1.51f, 0.31f, -2.04f, 0.81f)
                lineToRelative(-2.82f, -2.82f)
                curveToRelative(1.32f, -1.28f, 3.05f, -1.99f, 4.89f, -1.99f)
                close()
