...
val Icons.Ts.SurveillanceCamera: ImageVector
    get() = _SurveillanceCamera ?: UXIcon(name = "SurveillanceCamera") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(23.76f, 19.27f)
                curveToRelative(-0.52f, -1.0f, -2.55f, -4.27f, -6.76f, -4.27f)
                reflectiveCurveToRelative(-6.24f, 3.27f, -6.76f, 4.27f)
