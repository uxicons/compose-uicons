...
val Icons.Ts.Saturday: ImageVector
    get() = _Saturday ?: UXIcon(name = "Saturday") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(16.5f, 16f)
                curveToRelative(-0.97f, 0f, -1.12f, 0.69f, -1.2f, 1.09f)
                lineToRelative(-1.39f, 6.91f)
                ...
                curveToRelative(-0.09f, -0.46f, -0.24f, -1.12f, -1.21f, -1.12f)
                close()
                moveTo(15.53f, 21f)
