...
val Icons.Ts.FileChartPie: ImageVector
    get() = _FileChartPie ?: UXIcon(name = "FileChartPie") {
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveToRelative(-2.24f, -5f, -5f, -5f)
                close()
                moveTo(15.45f, 12.98f)
                lineToRelative(-2.95f, 1.26f)
                verticalLineToRelative(-3.21f)
                curveToRelative(1.26f, 0.16f, 2.33f, 0.9f, 2.95f, 1.95f)
                close()
                moveTo(12f, 19f)
                curveToRelative(-2.21f, 0f, -4f, -1.79f, -4f, -4f)
                curveToRelative(0f, -2.04f, 1.53f, -3.72f, 3.5f, -3.97f)
                verticalLineToRelative(4.73f)
                lineToRelative(4.34f, -1.86f)
                curveToRelative(0.1f, 0.35f, 0.15f, 0.72f, 0.15f, 1.1f)
