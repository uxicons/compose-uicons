...
val Icons.Br.LastSquare: ImageVector
    get() = _LastSquare ?: UXIcon(name = "LastSquare") {
        path(fill = SolidColor(Color.Black)) {
            ...
            lineToRelative(-5.19f, 3.85f)
            curveToRelative(-0.73f, 0.54f, -1.76f, 0.02f, -1.76f, -0.89f)
            verticalLineToRelative(-7.79f)
            curveToRelative(0f, -0.91f, 1.03f, -1.43f, 1.76f, -0.89f)
            lineToRelative(5.19f, 3.85f)
            verticalLineToRelative(-2.57f)
            curveToRelative(0f, -0.83f, 0.67f, -1.5f, 1.5f, -1.5f)
            reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f)
