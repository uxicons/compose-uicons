...
val Icons.Br.DigitalKey: ImageVector
    get() = _DigitalKey ?: UXIcon(name = "DigitalKey") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.46f, 0.46f, -0.46f, 1.21f, 0f, 1.68f)
            lineToRelative(1.21f, 1.21f)
            lineToRelative(-1.64f, 1.64f)
            reflectiveCurveToRelative(-0.5f, 0.48f, -0.5f, 0.88f)
            curveToRelative(0f, 0.56f, 0.2f, 1.0f, 0.56f, 1.36f)
