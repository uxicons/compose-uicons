...
val Icons.Br.HouseChimneyCrack: ImageVector
    get() = _HouseChimneyCrack ?: UXIcon(name = "HouseChimneyCrack") {
        path(fill = SolidColor(Color.Black)) {
            ...
            lineTo(2.42f, 5.33f)
            curveTo(0.91f, 6.35f, 0f, 8.05f, 0f, 9.89f)
            ...
            lineToRelative(1.85f, -5.37f)
            curveToRelative(0.28f, -0.8f, -0.32f, -1.63f, -1.16f, -1.63f)
            horizontalLineToRelative(-2.87f)
            lineToRelative(1.37f, -4.5f)
            curveToRelative(0.23f, -0.75f, -0.33f, -1.5f, -1.11f, -1.5f)
            curveToRelative(-0.39f, 0f, -0.76f, 0.2f, -0.97f, 0.53f)
            lineToRelative(-4.95f, 7.36f)
            curveToRelative(-0.59f, 0.91f, 0.06f, 2.11f, 1.15f, 2.11f)
