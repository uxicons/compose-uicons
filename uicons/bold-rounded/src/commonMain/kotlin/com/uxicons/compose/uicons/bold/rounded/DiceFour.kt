...
val Icons.Br.DiceFour: ImageVector
    get() = _DiceFour ?: UXIcon(name = "DiceFour") {
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(18f, 7.5f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = true, isPositiveArc = true, 16.5f, 6f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 18f, 7.5f)
            close()
            moveTo(9f, 16.5f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = true, isPositiveArc = true, 7.5f, 15f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 9f, 16.5f)
            close()
            moveTo(18f, 16.5f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = true, isPositiveArc = true, 16.5f, 15f)
