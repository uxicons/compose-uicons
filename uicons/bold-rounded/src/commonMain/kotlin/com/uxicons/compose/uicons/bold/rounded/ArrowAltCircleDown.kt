...
val Icons.Br.ArrowAltCircleDown: ImageVector
    get() = _ArrowAltCircleDown ?: UXIcon(name = "ArrowAltCircleDown") {
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(16.76f, 13.51f)
            lineToRelative(-4.21f, 4.26f)
            curveToRelative(-0.3f, 0.31f, -0.8f, 0.31f, -1.1f, 0f)
            lineToRelative(-4.2f, -4.25f)
            curveToRelative(-0.56f, -0.56f, -0.16f, -1.52f, 0.63f, -1.52f)
            ...
            curveToRelative(0.79f, 0f, 1.18f, 0.95f, 0.63f, 1.51f)
            close()
        }
