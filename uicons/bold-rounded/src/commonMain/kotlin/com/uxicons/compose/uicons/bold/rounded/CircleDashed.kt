...
val Icons.Br.CircleDashed: ImageVector
    get() = _CircleDashed ?: UXIcon(name = "CircleDashed") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.32f, 0f, -0.64f, -0.1f, -0.92f, -0.31f)
            ...
            curveToRelative(0.45f, 0f, 0.89f, -0.2f, 1.19f, -0.58f)
            curveToRelative(0.51f, -0.66f, 0.39f, -1.6f, -0.27f, -2.1f)
            close()
            moveTo(3.09f, 13.29f)
            ...
            curveToRelative(-0.82f, 0.12f, -1.39f, 0.88f, -1.27f, 1.7f)
            curveToRelative(0.11f, 0.75f, 0.75f, 1.29f, 1.48f, 1.29f)
            curveToRelative(0.07f, 0f, 1.07f, -0.11f, 1.5f, -0.11f)
