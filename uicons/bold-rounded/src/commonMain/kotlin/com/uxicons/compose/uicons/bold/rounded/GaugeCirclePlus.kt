...
val Icons.Br.GaugeCirclePlus: ImageVector
    get() = _GaugeCirclePlus ?: UXIcon(name = "GaugeCirclePlus") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.76f, 0f, 1.5f, -0.25f, 2.12f, -0.76f)
