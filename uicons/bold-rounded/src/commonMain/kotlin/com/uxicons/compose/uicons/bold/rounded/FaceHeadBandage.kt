...
val Icons.Br.FaceHeadBandage: ImageVector
    get() = _FaceHeadBandage ?: UXIcon(name = "FaceHeadBandage") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-4.48f, 0f, -8.21f, -3.3f, -8.89f, -7.59f)
            ...
            reflectiveCurveToRelative(1.5f, -0.67f, 1.5f, -1.5f)
            curveToRelative(0f, -0.33f, -0.11f, -0.64f, -0.29f, -0.89f)
            ...
            curveToRelative(-0.27f, 0f, -0.55f, -0.07f, -0.8f, -0.23f)
            ...
            curveToRelative(0.2f, -0.13f, 2f, -1.24f, 4.31f, -1.24f)
