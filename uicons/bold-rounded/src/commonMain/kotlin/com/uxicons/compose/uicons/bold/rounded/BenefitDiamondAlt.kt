...
val Icons.Br.BenefitDiamondAlt: ImageVector
    get() = _BenefitDiamondAlt ?: UXIcon(name = "BenefitDiamondAlt") {
        path(fill = SolidColor(Color.Black)) {
            moveToRelative(6.43f, 5.07f)
            ...
            verticalLineToRelative(-2.81f)
            curveToRelative(0f, -0.84f, -0.15f, -1.66f, -0.43f, -2.44f)
            ...
            curveToRelative(0.29f, 0.3f, 0.68f, 0.44f, 1.06f, 0.44f)
            curveToRelative(0.38f, 0f, 0.76f, -0.14f, 1.06f, -0.44f)
