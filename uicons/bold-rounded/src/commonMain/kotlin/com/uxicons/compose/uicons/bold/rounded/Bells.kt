...
val Icons.Br.Bells: ImageVector
    get() = _Bells ?: UXIcon(name = "Bells") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-3.89f, 0f, -7.2f, 2.65f, -8.02f, 6.37f)
            ...
            curveToRelative(0.22f, 1.69f, 1.65f, 3f, 3.4f, 3f)
            reflectiveCurveToRelative(3.18f, -1.31f, 3.4f, -3f)
            horizontalLineToRelative(1.36f)
            curveToRelative(1.49f, 0f, 2.87f, -0.68f, 3.78f, -1.87f)
            curveToRelative(0.9f, -1.19f, 1.19f, -2.7f, 0.79f, -4.14f)
            close()
            moveTo(20.64f, 17.31f)
            curveToRelative(-0.33f, 0.44f, -0.84f, 0.69f, -1.38f, 0.69f)
            lineTo(9.74f, 18f)
            curveToRelative(-0.53f, 0f, -1.03f, -0.24f, -1.36f, -0.65f)
            curveToRelative(-0.33f, -0.41f, -0.46f, -0.95f, -0.36f, -1.39f)
            lineToRelative(1.36f, -4.86f)
            curveToRelative(0.54f, -2.42f, 2.64f, -4.1f, 5.12f, -4.1f)
            curveToRelative(2.35f, 0f, 4.42f, 1.58f, 5.05f, 3.84f)
            lineToRelative(1.38f, 4.96f)
            ...
            lineTo(1.47f, 6.37f)
            curveTo(2.3f, 2.65f, 5.61f, 0f, 9.5f, 0f)
            curveTo(9.91f, 0f, 10.32f, 0.03f, 10.72f, 0.09f)
            ...
            curveToRelative(-2.47f, 0f, -4.58f, 1.69f, -5.12f, 4.1f)
            lineToRelative(-1.36f, 4.86f)
            close()
        }
    }.also { _Bells = it }
