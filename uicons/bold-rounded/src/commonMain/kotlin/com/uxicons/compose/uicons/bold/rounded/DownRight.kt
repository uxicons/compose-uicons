...
val Icons.Br.DownRight: ImageVector
    get() = _DownRight ?: UXIcon(name = "DownRight") {
        path(fill = SolidColor(Color.Black)) {
            moveTo(10.36f, 23f)
            curveToRelative(-1.36f, 0f, -2.58f, -0.81f, -3.1f, -2.07f)
            ...
            curveToRelative(1.37f, -1.36f, 3.59f, -1.36f, 4.95f, 0f)
            ...
            curveToRelative(0.71f, 0f, 1.28f, -0.58f, 1.28f, -1.29f)
            verticalLineTo(10.36f)
            curveToRelative(0f, -0.16f, -0.07f, -0.27f, -0.22f, -0.33f)
