...
val Icons.Br.KeyboardDown: ImageVector
    get() = _KeyboardDown ?: UXIcon(name = "KeyboardDown") {
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f)
            close()
            moveTo(15.06f, 21.25f)
            lineToRelative(-2.17f, 2.37f)
            curveToRelative(-0.44f, 0.49f, -1.22f, 0.49f, -1.66f, 0f)
            lineToRelative(-2.17f, -2.37f)
            curveToRelative(-0.44f, -0.48f, -0.1f, -1.25f, 0.55f, -1.25f)
            horizontalLineToRelative(4.9f)
            curveToRelative(0.65f, 0f, 0.99f, 0.78f, 0.55f, 1.25f)
            close()
        }
