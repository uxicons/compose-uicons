...
val Icons.Br.CloudQuestion: ImageVector
    get() = _CloudQuestion ?: UXIcon(name = "CloudQuestion") {
        path(fill = SolidColor(Color.Black)) {
            moveToRelative(13f, 20.5f)
            curveToRelative(0f, 0.83f, -0.67f, 1.5f, -1.5f, 1.5f)
            reflectiveCurveToRelative(-1.5f, -0.67f, -1.5f, -1.5f)
            reflectiveCurveToRelative(0.67f, -1.5f, 1.5f, -1.5f)
            reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f)
            close()
            moveTo(15.37f, 11.96f)
            curveToRelative(-0.35f, -1.36f, -1.46f, -2.48f, -2.83f, -2.83f)
            curveToRelative(-1.23f, -0.32f, -2.5f, -0.06f, -3.49f, 0.7f)
            curveToRelative(-0.99f, 0.76f, -1.55f, 1.92f, -1.55f, 3.16f)
            curveToRelative(0f, 0.83f, 0.67f, 1.5f, 1.5f, 1.5f)
            reflectiveCurveToRelative(1.5f, -0.67f, 1.5f, -1.5f)
            curveToRelative(0f, -0.31f, 0.14f, -0.6f, 0.39f, -0.79f)
            curveToRelative(0.15f, -0.11f, 0.45f, -0.28f, 0.9f, -0.17f)
            curveToRelative(0.31f, 0.08f, 0.59f, 0.36f, 0.67f, 0.67f)
            curveToRelative(0.15f, 0.58f, -0.16f, 1.02f, -0.54f, 1.2f)
            curveToRelative(-0.93f, 0.43f, -1.62f, 1.26f, -1.87f, 2.22f)
            ...
            curveToRelative(0.02f, -0.07f, 0.11f, -0.19f, 0.23f, -0.24f)
            curveToRelative(1.76f, -0.81f, 2.68f, -2.78f, 2.19f, -4.67f)
            close()
            moveTo(17.81f, 5.92f)
