...
val Icons.Br.EarDeaf: ImageVector
    get() = _EarDeaf ?: UXIcon(name = "EarDeaf") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(3.71f, 0f, 6.5f, -2.63f, 6.5f, -6.13f)
            curveToRelative(0f, -0.86f, 0.5f, -1.36f, 0.8f, -1.66f)
            ...
            curveToRelative(0.42f, 0f, 0.83f, -0.17f, 1.13f, -0.51f)
            curveToRelative(0.84f, -0.95f, 1.38f, -2.32f, 1.38f, -3.49f)
            curveToRelative(0f, -2.76f, -2.24f, -5f, -5f, -5f)
            curveToRelative(-2.49f, 0f, -4.64f, 1.84f, -4.98f, 4.29f)
            ...
            curveToRelative(0f, 0.46f, -0.27f, 1.1f, -0.62f, 1.51f)
