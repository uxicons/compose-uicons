...
val Icons.Br.AstonishedFace: ImageVector
    get() = _AstonishedFace ?: UXIcon(name = "AstonishedFace") {
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(16.77f, 15.8f)
            arcTo(5.87f, 5.87f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 13f)
            arcToRelative(5.87f, 5.87f, 0f, isMoreThanHalf = false, isPositiveArc = false, -4.77f, 2.8f)
            arcTo(1.47f, 1.47f, 0f, isMoreThanHalf = false, isPositiveArc = false, 8.5f, 18f)
            horizontalLineToRelative(7f)
            arcTo(1.47f, 1.47f, 0f, isMoreThanHalf = false, isPositiveArc = false, 16.77f, 15.8f)
            close()
        }
    }.also { _AstonishedFace = it }
