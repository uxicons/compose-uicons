...
val Icons.Br.DropdownSelect: ImageVector
    get() = _DropdownSelect ?: UXIcon(name = "DropdownSelect") {
        path(fill = SolidColor(Color.Black)) {
            ...
            verticalLineToRelative(13f)
            close()
            moveTo(16.14f, 11.86f)
            lineToRelative(-3.18f, 3.18f)
            curveToRelative(-0.53f, 0.53f, -1.39f, 0.53f, -1.92f, 0f)
            lineToRelative(-3.18f, -3.18f)
            curveToRelative(-0.69f, -0.69f, -0.2f, -1.86f, 0.77f, -1.86f)
            horizontalLineToRelative(6.74f)
            curveToRelative(0.97f, 0f, 1.46f, 1.17f, 0.77f, 1.86f)
            close()
        }
