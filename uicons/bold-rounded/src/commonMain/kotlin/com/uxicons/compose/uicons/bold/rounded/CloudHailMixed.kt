...
val Icons.Br.CloudHailMixed: ImageVector
    get() = _CloudHailMixed ?: UXIcon(name = "CloudHailMixed") {
        path(fill = SolidColor(Color.Black)) {
            moveTo(13.5f, 20f)
            arcToRelative(1.53f, 1.53f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.36f, -0.04f)
            arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.09f, -1.82f)
            lineToRelative(1f, -4f)
            arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = true, isPositiveArc = true, 2.91f, 0.73f)
            lineToRelative(-1f, 4f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 13.5f, 20f)
            close()
            ...
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12.5f, 21f)
            close()
            moveTo(8.96f, 22.86f)
            lineToRelative(1f, -4f)
            arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.91f, -0.73f)
            lineToRelative(-1f, 4f)
            arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.09f, 1.82f)
            arcTo(1.53f, 1.53f, 0f, isMoreThanHalf = false, isPositiveArc = false, 7.5f, 24f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 8.96f, 22.86f)
            close()
            moveTo(9.5f, 16f)
            arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, -3f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 9.5f, 16f)
            close()
        }
