...
val Icons.Br.SeventySMusicDisc: ImageVector
    get() = _70SMusicDisc ?: UXIcon(name = "70SMusicDisc") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.71f, 0f, 1.35f, 0.37f, 1.72f, 0.98f)
            reflectiveCurveToRelative(0.37f, 1.35f, 0.03f, 1.98f)
            curveToRelative(-0.02f, 0.03f, -3.93f, 5.62f, -3.93f, 5.62f)
