...
val Icons.Br.HandHoldingWater: ImageVector
    get() = _HandHoldingWater ?: UXIcon(name = "HandHoldingWater") {
        path(fill = SolidColor(Color.Black)) {
            moveTo(22.73f, 9.01f)
            curveToRelative(-0.77f, -0.7f, -1.75f, -1.06f, -2.79f, -1.01f)
            ...
            reflectiveCurveToRelative(0.88f, 1.38f, 1.7f, 1.27f)
            lineToRelative(5.16f, -0.74f)
            ...
            curveToRelative(0.23f, -0.02f, 0.46f, 0.07f, 0.64f, 0.23f)
            curveToRelative(0.36f, 0.33f, 0.39f, 0.88f, 0.05f, 1.25f)
            close()
            moveTo(6.03f, 6.97f)
            curveToRelative(-0.66f, -0.66f, -1.02f, -1.54f, -1.02f, -2.48f)
            curveToRelative(0f, -1.57f, 1.99f, -3.4f, 2.49f, -3.95f)
            curveToRelative(0.78f, -0.76f, 1.28f, -0.71f, 2.01f, 0f)
            curveToRelative(0.54f, 0.58f, 2.5f, 2.34f, 2.5f, 3.95f)
