...
val Icons.Br.CircleO: ImageVector
    get() = _CircleO ?: UXIcon(name = "CircleO") {
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(12f, 5.75f)
            curveToRelative(-2.76f, 0f, -5.01f, 2.26f, -5.01f, 5.04f)
            verticalLineToRelative(2.43f)
            curveToRelative(0f, 2.78f, 2.25f, 5.04f, 5.01f, 5.04f)
            reflectiveCurveToRelative(4.99f, -2.26f, 4.99f, -5.04f)
            verticalLineToRelative(-2.43f)
            curveToRelative(0f, -2.78f, -2.24f, -5.04f, -4.99f, -5.04f)
            close()
            moveTo(13.99f, 13.21f)
            curveToRelative(0f, 1.14f, -0.88f, 2.04f, -1.99f, 2.04f)
