...
val Icons.Br.HeadSideHeart: ImageVector
    get() = _HeadSideHeart ?: UXIcon(name = "HeadSideHeart") {
        path(fill = SolidColor(Color.Black)) {
            ...
            close()
            moveTo(15.01f, 10.16f)
            curveToRelative(0f, 1.77f, -2.45f, 3.86f, -3.51f, 4.68f)
            curveToRelative(-0.29f, 0.22f, -0.68f, 0.22f, -0.97f, 0f)
            curveToRelative(-1.07f, -0.82f, -3.51f, -2.91f, -3.51f, -4.68f)
