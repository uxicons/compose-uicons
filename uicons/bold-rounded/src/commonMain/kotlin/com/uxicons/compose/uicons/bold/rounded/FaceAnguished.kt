...
val Icons.Br.FaceAnguished: ImageVector
    get() = _FaceAnguished ?: UXIcon(name = "FaceAnguished") {
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveToRelative(2f, 0.9f, 2f, 2f)
            close()
            moveTo(15.81f, 17.24f)
            curveToRelative(0.45f, 0.79f, -0.11f, 1.76f, -1.01f, 1.76f)
            horizontalLineToRelative(-5.6f)
            curveToRelative(-0.9f, 0f, -1.46f, -0.98f, -1.01f, -1.76f)
            curveToRelative(0.67f, -1.18f, 2.23f, -2.23f, 3.81f, -2.24f)
            curveToRelative(1.58f, 0.0f, 3.14f, 1.06f, 3.81f, 2.24f)
            close()
        }
