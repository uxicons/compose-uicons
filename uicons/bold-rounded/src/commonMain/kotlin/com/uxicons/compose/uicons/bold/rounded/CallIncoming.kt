...
val Icons.Br.CallIncoming: ImageVector
    get() = _CallIncoming ?: UXIcon(name = "CallIncoming") {
        path(fill = SolidColor(Color.Black)) {
            ...
            lineTo(7.86f, 1.02f)
            arcTo(3.58f, 3.58f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.95f, 0.98f)
            reflectiveCurveToRelative(-1.07f, 0.93f, -1.09f, 0.95f)
            curveToRelative(-7.89f, 8.27f, 11.92f, 28.1f, 20.2f, 20.2f)
            ...
            lineTo(21.44f, 0.44f)
            arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.13f, 2.12f)
            lineTo(20.02f, 6.13f)
            lineToRelative(1.17f, 1.17f)
            arcTo(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 20.47f, 9f)
            lineTo(16f, 9f)
