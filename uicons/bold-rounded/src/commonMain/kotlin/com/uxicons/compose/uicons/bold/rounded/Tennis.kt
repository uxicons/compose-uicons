...
val Icons.Br.Tennis: ImageVector
    get() = _Tennis ?: UXIcon(name = "Tennis") {
        path(fill = SolidColor(Color.Black)) {
            moveToRelative(20.49f, 3.51f)
            ...
            arcToRelative(8.92f, 8.92f, 0f, isMoreThanHalf = false, isPositiveArc = true, -6.75f, -6.75f)
            close()
            moveTo(18.37f, 18.36f)
            arcToRelative(8.96f, 8.96f, 0f, isMoreThanHalf = false, isPositiveArc = true, -5.38f, 2.57f)
            ...
            arcToRelative(8.96f, 8.96f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.57f, 5.37f)
            close()
        }
    }.also { _Tennis = it }
