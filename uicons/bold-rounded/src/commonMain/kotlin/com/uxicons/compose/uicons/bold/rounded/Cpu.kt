...
val Icons.Br.Cpu: ImageVector
    get() = _Cpu ?: UXIcon(name = "Cpu") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.29f, 0.01f, 0.55f, 0.19f, 0.68f, 0.44f)
            curveToRelative(0.1f, 0.2f, 0.3f, 0.31f, 0.52f, 0.31f)
            horizontalLineToRelative(0.02f)
            curveToRelative(0.47f, 0f, 0.78f, -0.5f, 0.56f, -0.92f)
