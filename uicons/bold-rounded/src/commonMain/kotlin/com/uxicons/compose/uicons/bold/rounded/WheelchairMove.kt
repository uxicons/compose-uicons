...
val Icons.Br.WheelchairMove: ImageVector
    get() = _WheelchairMove ?: UXIcon(name = "WheelchairMove") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-1.7f, 0f, -3.29f, 0.99f, -4.04f, 2.52f)
            ...
            curveToRelative(0.55f, 0f, 1.09f, -0.31f, 1.35f, -0.84f)
            lineToRelative(1.14f, -2.32f)
            ...
            curveToRelative(0f, -0.98f, 0.28f, -1.93f, 0.82f, -2.75f)
            ...
            curveToRelative(4.1f, 0f, 7.48f, -3.1f, 7.94f, -7.07f)
            ...
            curveToRelative(0.54f, 0f, 1.06f, -0.29f, 1.33f, -0.81f)
