...
val Icons.Br.SortAlphaDown: ImageVector
    get() = _SortAlphaDown ?: UXIcon(name = "SortAlphaDown") {
        path(fill = SolidColor(Color.Black)) {
            moveTo(23f, 22.5f)
            curveToRelative(0f, 0.83f, -0.67f, 1.5f, -1.5f, 1.5f)
            horizontalLineToRelative(-4.11f)
            curveToRelative(-0.87f, 0f, -1.67f, -0.47f, -2.09f, -1.23f)
            curveToRelative(-0.42f, -0.76f, -0.4f, -1.69f, 0.06f, -2.42f)
            curveToRelative(0.05f, -0.07f, 3.86f, -4.35f, 3.86f, -4.35f)
            ...
            reflectiveCurveToRelative(1.28f, -0.24f, 1.76f, -0.73f)
