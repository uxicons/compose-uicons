...
val Icons.Br.Dollar: ImageVector
    get() = _Dollar ?: UXIcon(name = "Dollar") {
        path(fill = SolidColor(Color.Black)) {
            moveTo(18.5f, 9.5f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 20f, 8f)
            lineTo(20f, 7.31f)
            ...
            lineTo(17f, 8f)
            arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 18.5f, 9.5f)
            close()
