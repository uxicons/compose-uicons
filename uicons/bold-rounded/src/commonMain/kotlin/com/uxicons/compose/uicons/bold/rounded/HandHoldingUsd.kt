...
val Icons.Br.HandHoldingUsd: ImageVector
    get() = _HandHoldingUsd ?: UXIcon(name = "HandHoldingUsd") {
        path(fill = SolidColor(Color.Black)) {
            ...
            lineTo(4.51f, 24f)
            curveTo(2.02f, 24f, 0f, 21.98f, 0f, 19.5f)
            verticalLineToRelative(-4f)
            curveTo(0f, 13.02f, 2.02f, 11f, 4.51f, 11f)
            ...
            lineToRelative(5.16f, -0.74f)
            curveToRelative(0.31f, -0.04f, 0.55f, -0.32f, 0.55f, -0.63f)
            ...
            curveToRelative(2.16f, 0f, 4.22f, -0.93f, 5.65f, -2.56f)
