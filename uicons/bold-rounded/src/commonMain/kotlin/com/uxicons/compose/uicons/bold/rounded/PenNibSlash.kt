...
val Icons.Br.PenNibSlash: ImageVector
    get() = _PenNibSlash ?: UXIcon(name = "PenNibSlash") {
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(-0.82f, 0f, -1.62f, -0.32f, -2.21f, -0.92f)
            curveToRelative(-0.81f, -0.81f, -1.12f, -2f, -0.79f, -3.1f)
            lineTo(2.8f, 10.59f)
            ...
            curveToRelative(0f, -0.65f, 0.3f, -1.23f, 0.77f, -1.61f)
