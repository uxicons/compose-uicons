...
val Icons.Br.FingerDroplet: ImageVector
    get() = _FingerDroplet ?: UXIcon(name = "FingerDroplet") {
        path(fill = SolidColor(Color.Black)) {
            moveToRelative(24f, 20.03f)
            curveToRelative(0f, 1.01f, -0.5f, 1.95f, -1.38f, 2.53f)
            curveToRelative(-0.96f, 0.63f, -2.24f, 0.63f, -3.21f, 0.02f)
            curveToRelative(-0.9f, -0.58f, -1.41f, -1.52f, -1.41f, -2.55f)
            ...
            curveToRelative(0.78f, -0.78f, 1.82f, -1.21f, 2.93f, -1.21f)
            horizontalLineToRelative(0.01f)
            curveToRelative(1.11f, 0.0f, 2.15f, 0.44f, 2.93f, 1.22f)
            lineToRelative(3.94f, 3.78f)
            ...
            lineToRelative(-1.71f, -1.64f)
            curveToRelative(-0.24f, -0.24f, -0.53f, -0.36f, -0.83f, -0.36f)
            horizontalLineToRelative(-0.0f)
            curveToRelative(-0.3f, 0f, -0.59f, 0.12f, -0.81f, 0.33f)
            lineToRelative(-2.31f, 2.31f)
