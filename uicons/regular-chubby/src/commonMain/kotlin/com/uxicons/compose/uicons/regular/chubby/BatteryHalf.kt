...
val Icons.Rc.BatteryHalf: ImageVector
    get() = _BatteryHalf ?: UXIcon(name = "BatteryHalf") {
            ...
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(11.09f, 8f)
                curveToRelative(-1.57f, 0f, -3.24f, 0.12f, -4.98f, 0.34f)
                ...
                curveToRelative(0.55f, 0f, 0.91f, -0.45f, 0.91f, -1f)
                verticalLineToRelative(-6f)
                curveToRelative(0f, -0.55f, -0.36f, -1f, -0.91f, -1f)
                close()
            }
