...
val Icons.Rc.FireFlameCurved: ImageVector
    get() = _FireFlameCurved ?: UXIcon(name = "FireFlameCurved") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 0.2f, 0.01f, 0.44f, 0.02f, 0.71f)
                curveToRelative(0.04f, 1.04f, 0.1f, 2.98f, -0.51f, 3.61f)
                ...
                close()
                moveTo(12f, 21f)
                curveToRelative(-4.83f, 0f, -7.5f, -2.66f, -7.5f, -7.5f)
                curveToRelative(0f, -0.21f, 0.02f, -0.43f, 0.06f, -0.66f)
                curveToRelative(0.69f, 1.44f, 1.81f, 1.66f, 2.44f, 1.66f)
                curveToRelative(0.77f, 0f, 1.45f, -0.28f, 1.95f, -0.8f)
                curveToRelative(1.2f, -1.24f, 1.12f, -3.54f, 1.06f, -5.06f)
                curveToRelative(-0.01f, -0.24f, -0.02f, -0.46f, -0.02f, -0.64f)
                curveToRelative(0f, -3.17f, 2.56f, -4.36f, 4.06f, -4.79f)
                curveToRelative(0.3f, 3.18f, 1.8f, 4.65f, 3.13f, 5.97f)
                curveToRelative(1.29f, 1.27f, 2.31f, 2.28f, 2.31f, 4.81f)
