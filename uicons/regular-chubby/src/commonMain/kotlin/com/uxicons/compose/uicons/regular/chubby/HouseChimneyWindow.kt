...
val Icons.Rc.HouseChimneyWindow: ImageVector
    get() = _HouseChimneyWindow ?: UXIcon(name = "HouseChimneyWindow") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(14.93f, 9.88f)
                curveToRelative(-0.06f, -0.02f, -1.38f, -0.38f, -2.93f, -0.38f)
                reflectiveCurveToRelative(-2.87f, 0.37f, -2.92f, 0.38f)
                curveToRelative(-0.33f, 0.09f, -0.59f, 0.35f, -0.69f, 0.67f)
                curveToRelative(-0.02f, 0.05f, -0.39f, 1.3f, -0.39f, 2.94f)
                curveToRelative(0f, 1.66f, 0.37f, 2.9f, 0.39f, 2.95f)
                ...
                curveToRelative(-0.1f, -0.33f, -0.36f, -0.58f, -0.69f, -0.67f)
                close()
                moveTo(13.82f, 15.32f)
                curveToRelative(-0.45f, 0.09f, -1.11f, 0.18f, -1.82f, 0.18f)
                reflectiveCurveToRelative(-1.38f, -0.1f, -1.82f, -0.18f)
                curveToRelative(-0.08f, -0.43f, -0.17f, -1.07f, -0.17f, -1.82f)
                curveToRelative(0f, -0.74f, 0.09f, -1.39f, 0.18f, -1.82f)
                curveToRelative(0.45f, -0.09f, 1.11f, -0.18f, 1.82f, -0.18f)
                reflectiveCurveToRelative(1.38f, 0.1f, 1.82f, 0.18f)
                curveToRelative(0.08f, 0.43f, 0.17f, 1.07f, 0.17f, 1.82f)
                curveToRelative(0f, 0.74f, -0.09f, 1.39f, -0.18f, 1.82f)
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.26f, -0.11f, 0.46f, -0.33f, 0.56f, -0.6f)
                curveToRelative(0.04f, -0.13f, 1.05f, -3.19f, 1.05f, -6.32f)
                curveToRelative(0f, -5.2f, -1.47f, -7.88f, -1.54f, -7.99f)
                close()
                moveTo(12f, 21f)
