...
val Icons.Rc.SortCircleDown: ImageVector
    get() = _SortCircleDown ?: UXIcon(name = "SortCircleDown") {
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(12.0f, 7.17f)
                curveToRelative(0.79f, 0.51f, 1.49f, 1.07f, 2.1f, 1.7f)
                curveToRelative(-1.21f, 0.14f, -3f, 0.14f, -4.21f, 0f)
                curveToRelative(0.61f, -0.63f, 1.31f, -1.19f, 2.11f, -1.7f)
                close()
            }
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(16.23f, 13.44f)
