...
val Icons.Rc.BatteryFull: ImageVector
    get() = _BatteryFull ?: UXIcon(name = "BatteryFull") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(15.9f, 8.34f)
                curveToRelative(-1.71f, -0.23f, -3.36f, -0.34f, -4.91f, -0.34f)
                reflectiveCurveToRelative(-3.19f, 0.12f, -4.9f, 0.34f)
                curveToRelative(-0.43f, 0.06f, -0.77f, 0.39f, -0.84f, 0.81f)
                curveToRelative(-0.17f, 0.96f, -0.26f, 1.92f, -0.26f, 2.84f)
                reflectiveCurveToRelative(0.09f, 1.89f, 0.25f, 2.84f)
                curveToRelative(0.08f, 0.43f, 0.42f, 0.76f, 0.84f, 0.82f)
                curveToRelative(1.71f, 0.23f, 3.36f, 0.34f, 4.91f, 0.34f)
                reflectiveCurveToRelative(3.19f, -0.12f, 4.9f, -0.34f)
                curveToRelative(0.43f, -0.06f, 0.77f, -0.39f, 0.84f, -0.81f)
                curveToRelative(0.17f, -0.96f, 0.26f, -1.91f, 0.26f, -2.84f)
                reflectiveCurveToRelative(-0.09f, -1.89f, -0.25f, -2.84f)
                curveToRelative(-0.08f, -0.43f, -0.42f, -0.76f, -0.84f, -0.81f)
                close()
            }
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.28f, -0.89f, -0.8f, -2.89f, -0.8f, -5.32f)
                ...
                curveToRelative(0.28f, 0.89f, 0.8f, 2.89f, 0.8f, 5.32f)
                curveToRelative(0f, 2.42f, -0.53f, 4.42f, -0.81f, 5.32f)
                curveToRelative(-1.17f, 0.21f, -4.08f, 0.68f, -7.29f, 0.68f)
                close()
            }
