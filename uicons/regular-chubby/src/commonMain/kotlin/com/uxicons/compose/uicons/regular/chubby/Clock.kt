...
val Icons.Rc.Clock: ImageVector
    get() = _Clock ?: UXIcon(name = "Clock") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(11.99f, 1f)
                curveTo(4.93f, 1.04f, 1f, 5.17f, 1f, 11.98f)
                curveToRelative(0f, 6.91f, 3.93f, 10.98f, 11.01f, 11.02f)
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.59f, 0.55f, 1.22f, 0.2f, 1.41f, 0f)
