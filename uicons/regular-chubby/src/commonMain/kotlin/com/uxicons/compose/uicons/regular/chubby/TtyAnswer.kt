...
val Icons.Rc.TtyAnswer: ImageVector
    get() = _TtyAnswer ?: UXIcon(name = "TtyAnswer") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 1.32f, -0.56f, 2.59f, -1.52f, 3.48f)
                curveToRelative(-0.07f, 0.07f, -0.15f, 0.14f, -0.23f, 0.21f)
                curveToRelative(0.26f, 0.63f, 1.08f, 1.97f, 1.96f, 2.85f)
                reflectiveCurveToRelative(2.21f, 1.71f, 2.85f, 1.96f)
                curveToRelative(0.08f, -0.09f, 0.15f, -0.16f, 0.21f, -0.24f)
                ...
                curveToRelative(-1.26f, 0.04f, -3.58f, -1.66f, -4.55f, -2.63f)
                reflectiveCurveToRelative(-2.67f, -3.31f, -2.63f, -4.55f)
                curveToRelative(0.01f, -0.37f, 0.16f, -0.69f, 0.42f, -0.92f)
                curveToRelative(0.2f, -0.17f, 0.39f, -0.34f, 0.53f, -0.47f)
                curveToRelative(0.57f, -0.53f, 0.88f, -1.25f, 0.88f, -2.02f)
                curveToRelative(0f, -1.52f, -1.23f, -2.75f, -2.75f, -2.75f)
                curveToRelative(-1.45f, 0f, -3.75f, 1.22f, -3.75f, 4.5f)
                curveToRelative(0f, 1.71f, 1.79f, 5.88f, 4.71f, 8.79f)
                reflectiveCurveToRelative(7.09f, 4.71f, 8.79f, 4.71f)
