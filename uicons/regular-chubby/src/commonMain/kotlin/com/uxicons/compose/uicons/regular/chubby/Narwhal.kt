...
val Icons.Rc.Narwhal: ImageVector
    get() = _Narwhal ?: UXIcon(name = "Narwhal") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.65f, 0f, 1.25f, 0.04f, 1.81f, 0.11f)
                curveToRelative(0.58f, -1.25f, 2.22f, -4.62f, 3.91f, -6.73f)
                curveToRelative(0.28f, -0.35f, 0.78f, -0.47f, 1.19f, -0.29f)
                curveToRelative(0.42f, 0.19f, 0.65f, 0.63f, 0.58f, 1.08f)
                curveToRelative(-0.41f, 2.48f, -1.77f, 5.86f, -2.33f, 7.18f)
                curveToRelative(1.59f, 1.2f, 2.34f, 3.21f, 2.34f, 6.16f)
                close()
                moveTo(7f, 4.52f)
