...
val Icons.Rc.TrafficLight: ImageVector
    get() = _TrafficLight ?: UXIcon(name = "TrafficLight") {
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveToRelative(-0.79f, -8.87f, -0.82f, -9.04f)
                close()
                moveTo(17.31f, 20.11f)
                curveToRelative(-0.88f, 0.3f, -2.87f, 0.89f, -5.31f, 0.89f)
                curveToRelative(-2.42f, 0f, -4.42f, -0.58f, -5.31f, -0.89f)
                curveToRelative(-0.21f, -1.25f, -0.69f, -4.51f, -0.69f, -8.11f)
                reflectiveCurveToRelative(0.48f, -6.87f, 0.69f, -8.12f)
                curveToRelative(0.88f, -0.3f, 2.88f, -0.89f, 5.31f, -0.89f)
                curveToRelative(2.42f, 0f, 4.42f, 0.58f, 5.31f, 0.89f)
                curveToRelative(0.21f, 1.25f, 0.69f, 4.51f, 0.69f, 8.11f)
                reflectiveCurveToRelative(-0.48f, 6.87f, -0.69f, 8.12f)
                close()
