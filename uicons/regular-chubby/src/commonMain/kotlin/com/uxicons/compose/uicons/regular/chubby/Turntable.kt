...
val Icons.Rc.Turntable: ImageVector
    get() = _Turntable ?: UXIcon(name = "Turntable") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(12f, 20f)
                curveToRelative(-4.39f, 0f, -7.13f, -0.62f, -8.17f, -0.92f)
                curveToRelative(-0.26f, -1.08f, -0.83f, -3.77f, -0.83f, -7.08f)
                reflectiveCurveToRelative(0.56f, -6.0f, 0.83f, -7.08f)
                curveToRelative(1.04f, -0.29f, 3.78f, -0.92f, 8.17f, -0.92f)
                reflectiveCurveToRelative(7.13f, 0.62f, 8.17f, 0.92f)
                curveToRelative(0.26f, 1.08f, 0.83f, 3.77f, 0.83f, 7.08f)
                reflectiveCurveToRelative(-0.56f, 6.0f, -0.83f, 7.08f)
                curveToRelative(-1.04f, 0.29f, -3.78f, 0.92f, -8.17f, 0.92f)
                close()
