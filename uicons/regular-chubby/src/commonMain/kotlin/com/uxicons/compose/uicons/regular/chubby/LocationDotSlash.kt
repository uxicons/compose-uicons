...
val Icons.Rc.LocationDotSlash: ImageVector
    get() = _LocationDotSlash ?: UXIcon(name = "LocationDotSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.92f, -1.07f, 1.04f, -2.5f, 1.04f, -3.54f)
                curveToRelative(0f, -3.36f, -1.64f, -5f, -5f, -5f)
                curveToRelative(-1.55f, 0f, -2.72f, 0.34f, -3.55f, 1.04f)
                lineToRelative(-1.81f, -1.81f)
                curveToRelative(1.51f, -1.38f, 3.46f, -2.21f, 5.34f, -2.23f)
                close()
                moveTo(9.88f, 8.46f)
                curveToRelative(0.35f, -0.23f, 0.98f, -0.47f, 2.12f, -0.47f)
                curveToRelative(2.52f, 0f, 3f, 1.05f, 3f, 3f)
                curveToRelative(0f, 1.14f, -0.21f, 1.76f, -0.46f, 2.12f)
                close()
            }
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.17f, 0.71f, -0.27f, 1.51f, -0.27f, 2.23f)
