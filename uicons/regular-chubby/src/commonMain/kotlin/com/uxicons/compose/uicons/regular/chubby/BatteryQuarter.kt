...
val Icons.Rc.BatteryQuarter: ImageVector
    get() = _BatteryQuarter ?: UXIcon(name = "BatteryQuarter") {
            ...
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(8.47f, 8.2f)
                curveToRelative(-0.87f, 0.07f, -1.67f, 0.15f, -2.36f, 0.24f)
                curveToRelative(-0.43f, 0.06f, -0.78f, 0.39f, -0.85f, 0.81f)
                ...
                curveToRelative(0.79f, 0.1f, 1.58f, 0.2f, 2.36f, 0.24f)
                curveToRelative(0.84f, 0.04f, 1.03f, -0.62f, 1.03f, -0.9f)
                verticalLineToRelative(-6.1f)
                curveToRelative(0.03f, -0.41f, -0.3f, -0.86f, -1.03f, -0.8f)
                close()
            }
