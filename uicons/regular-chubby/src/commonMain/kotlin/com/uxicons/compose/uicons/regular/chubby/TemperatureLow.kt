...
val Icons.Rc.TemperatureLow: ImageVector
    get() = _TemperatureLow ?: UXIcon(name = "TemperatureLow") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(18.44f, 1.01f)
                curveToRelative(-2.68f, 0f, -3.24f, 1.76f, -3.24f, 3.24f)
                reflectiveCurveToRelative(0.56f, 3.24f, 3.24f, 3.24f)
                reflectiveCurveToRelative(3.25f, -1.76f, 3.25f, -3.24f)
                reflectiveCurveToRelative(-0.56f, -3.24f, -3.25f, -3.24f)
                close()
                moveTo(18.44f, 5.5f)
                curveToRelative(-0.96f, 0f, -1.24f, -0.16f, -1.24f, -1.24f)
                reflectiveCurveToRelative(0.28f, -1.24f, 1.24f, -1.24f)
                reflectiveCurveToRelative(1.25f, 0.16f, 1.25f, 1.24f)
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, -3.16f, 1.17f, -4.05f, 2.06f, -4.45f)
