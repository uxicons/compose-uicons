...
val Icons.Rc.Frown: ImageVector
    get() = _Frown ?: UXIcon(name = "Frown") {
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(11.99f, 1f)
                curveToRelative(-2.67f, 0.02f, -4.87f, 0.57f, -6.58f, 1.63f)
                curveTo(2.55f, 4.39f, 1.01f, 7.55f, 1f, 11.96f)
                curveToRelative(0f, 0.01f, 0f, 0.01f, 0f, 0.02f)
                verticalLineToRelative(0.04f)
                curveToRelative(0f, 3.18f, 0.82f, 5.74f, 2.37f, 7.58f)
                curveToRelative(1.84f, 2.23f, 4.74f, 3.38f, 8.63f, 3.4f)
