...
val Icons.Rc.StepBackward: ImageVector
    get() = _StepBackward ?: UXIcon(name = "StepBackward") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(20.99f, 1.72f)
                curveToRelative(-0.15f, -0.51f, -0.67f, -0.82f, -1.19f, -0.69f)
                curveToRelative(-0.13f, 0.03f, -3.23f, 0.79f, -8.34f, 4.2f)
                curveToRelative(-4.91f, 3.27f, -7.02f, 5.87f, -7.25f, 6.16f)
                curveToRelative(-0.1f, 0.12f, -0.15f, 0.27f, -0.18f, 0.41f)
                ...
                curveToRelative(0.03f, 0.15f, 0.08f, 0.29f, 0.18f, 0.41f)
                curveToRelative(0.23f, 0.29f, 2.34f, 2.89f, 7.25f, 6.16f)
                curveToRelative(5.11f, 3.41f, 8.21f, 4.17f, 8.34f, 4.2f)
                curveToRelative(0.51f, 0.12f, 1.04f, -0.18f, 1.19f, -0.69f)
                curveToRelative(0.04f, -0.14f, 1.01f, -3.55f, 1.01f, -10.28f)
                reflectiveCurveToRelative(-0.97f, -10.14f, -1.01f, -10.28f)
                close()
                moveTo(19.3f, 20.71f)
                curveToRelative(-1.23f, -0.46f, -3.56f, -1.49f, -6.73f, -3.6f)
                curveToRelative(-3.39f, -2.26f, -5.37f, -4.17f, -6.24f, -5.11f)
                curveToRelative(0.88f, -0.94f, 2.85f, -2.85f, 6.24f, -5.11f)
