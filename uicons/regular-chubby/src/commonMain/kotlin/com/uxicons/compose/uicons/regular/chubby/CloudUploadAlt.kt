...
val Icons.Rc.CloudUploadAlt: ImageVector
    get() = _CloudUploadAlt ?: UXIcon(name = "CloudUploadAlt") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(12.35f, 9.96f)
                curveToRelative(-0.22f, -0.08f, -0.47f, -0.08f, -0.69f, 0f)
                ...
                verticalLineToRelative(-3.06f)
                curveToRelative(0.18f, 0.24f, 0.35f, 0.53f, 0.54f, 0.86f)
                curveToRelative(0.45f, 0.77f, 1.2f, 0.5f, 1.35f, 0.42f)
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(16.99f, 19.5f)
                lineTo(5.18f, 19.5f)
                curveToRelative(-1.2f, 0f, -2.18f, -0.97f, -2.18f, -2.16f)
                curveToRelative(0f, -0.88f, 0.54f, -1.66f, 1.37f, -1.99f)
                curveToRelative(0.25f, -0.1f, 0.45f, -0.3f, 0.56f, -0.55f)
                curveToRelative(0.1f, -0.25f, 0.1f, -0.54f, -0.01f, -0.78f)
                curveToRelative(-0.38f, -0.86f, -0.57f, -1.78f, -0.57f, -2.73f)
                curveToRelative(0f, -3.74f, 3.04f, -6.79f, 6.79f, -6.79f)
                curveToRelative(3.64f, 0f, 6.62f, 2.84f, 6.78f, 6.47f)
                curveToRelative(0.02f, 0.39f, 0.26f, 0.73f, 0.62f, 0.88f)
                curveToRelative(1.5f, 0.62f, 2.47f, 2.06f, 2.47f, 3.67f)
