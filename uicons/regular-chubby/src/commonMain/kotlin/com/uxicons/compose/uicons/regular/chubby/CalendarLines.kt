...
val Icons.Rc.CalendarLines: ImageVector
    get() = _CalendarLines ?: UXIcon(name = "CalendarLines") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-1.46f, -0.18f, -3.19f, -0.31f, -5f, -0.31f)
                ...
                curveToRelative(1.3f, -0.26f, 4.62f, -0.85f, 8.19f, -0.85f)
                close()
                moveTo(20.18f, 20.15f)
                curveToRelative(-1.31f, 0.26f, -4.62f, 0.85f, -8.18f, 0.85f)
