...
val Icons.Tc.StepForward: ImageVector
    get() = _StepForward ?: UXIcon(name = "StepForward") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(3.46f, -2.28f, 5.57f, -4.22f, 6.67f, -5.34f)
                ...
                curveToRelative(0.04f, -0.15f, 1.03f, -3.65f, 1.03f, -10.64f)
                reflectiveCurveToRelative(-0.99f, -10.49f, -1.03f, -10.64f)
                close()
                moveTo(12.77f, 17.82f)
                ...
                curveToRelative(4.16f, 2.74f, 6.36f, 5.01f, 7.07f, 5.82f)
                curveToRelative(-0.72f, 0.81f, -2.91f, 3.08f, -7.07f, 5.82f)
                close()
            }
