...
val Icons.Tc.HouseChimneyMedical: ImageVector
    get() = _HouseChimneyMedical ?: UXIcon(name = "HouseChimneyMedical") {
            ...
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(16.51f, 10.74f)
                curveToRelative(-0.04f, -0.01f, -0.82f, -0.14f, -2.03f, -0.21f)
                curveToRelative(-0.08f, -1.21f, -0.21f, -2.0f, -0.21f, -2.03f)
                curveToRelative(-0.02f, -0.13f, -0.09f, -0.24f, -0.19f, -0.32f)
                curveToRelative(-0.04f, -0.03f, -0.91f, -0.68f, -2.07f, -0.68f)
                curveToRelative(-1.17f, 0f, -2.04f, 0.65f, -2.07f, 0.68f)
                curveToRelative(-0.1f, 0.08f, -0.17f, 0.19f, -0.19f, 0.32f)
                curveToRelative(-0.01f, 0.04f, -0.14f, 0.82f, -0.21f, 2.03f)
                curveToRelative(-1.21f, 0.08f, -2.0f, 0.2f, -2.03f, 0.21f)
                curveToRelative(-0.13f, 0.02f, -0.24f, 0.09f, -0.32f, 0.19f)
                curveToRelative(-0.03f, 0.04f, -0.68f, 0.91f, -0.68f, 2.07f)
                curveToRelative(0f, 1.17f, 0.65f, 2.04f, 0.68f, 2.07f)
                curveToRelative(0.08f, 0.1f, 0.19f, 0.17f, 0.32f, 0.19f)
                curveToRelative(0.04f, 0.01f, 0.82f, 0.14f, 2.03f, 0.21f)
                curveToRelative(0.08f, 1.21f, 0.21f, 2.0f, 0.21f, 2.03f)
                curveToRelative(0.02f, 0.13f, 0.09f, 0.24f, 0.19f, 0.32f)
                curveToRelative(0.04f, 0.03f, 0.91f, 0.68f, 2.07f, 0.68f)
                ...
                curveToRelative(-0.08f, -0.1f, -0.19f, -0.17f, -0.32f, -0.19f)
                close()
                moveTo(16.13f, 14.31f)
                curveToRelative(-0.36f, 0.05f, -1.14f, 0.14f, -2.15f, 0.19f)
                curveToRelative(-0.26f, 0.01f, -0.46f, 0.22f, -0.48f, 0.48f)
                curveToRelative(-0.05f, 1.01f, -0.14f, 1.79f, -0.19f, 2.15f)
                curveToRelative(-0.24f, 0.14f, -0.73f, 0.37f, -1.31f, 0.37f)
                curveToRelative(-0.58f, 0f, -1.07f, -0.23f, -1.31f, -0.37f)
                curveToRelative(-0.05f, -0.36f, -0.14f, -1.14f, -0.19f, -2.15f)
                curveToRelative(-0.01f, -0.26f, -0.22f, -0.46f, -0.48f, -0.48f)
                curveToRelative(-1.01f, -0.05f, -1.79f, -0.14f, -2.15f, -0.19f)
                curveToRelative(-0.14f, -0.24f, -0.37f, -0.73f, -0.37f, -1.31f)
                curveToRelative(0f, -0.58f, 0.23f, -1.07f, 0.37f, -1.31f)
                curveToRelative(0.36f, -0.05f, 1.14f, -0.14f, 2.15f, -0.19f)
                curveToRelative(0.26f, -0.01f, 0.46f, -0.22f, 0.48f, -0.48f)
                curveToRelative(0.05f, -1.01f, 0.14f, -1.79f, 0.19f, -2.15f)
                curveToRelative(0.24f, -0.14f, 0.73f, -0.37f, 1.31f, -0.37f)
