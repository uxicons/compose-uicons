...
val Icons.Tc.BracketsCurly: ImageVector
    get() = _BracketsCurly ?: UXIcon(name = "BracketsCurly") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(22.92f, 12.27f)
                ...
                curveToRelative(0.74f, -0.55f, 1.37f, -1.19f, 1.87f, -1.9f)
                curveToRelative(-0.5f, -0.71f, -1.13f, -1.34f, -1.87f, -1.9f)
                ...
                curveToRelative(0.03f, -0.28f, 0.3f, -0.47f, 0.55f, -0.44f)
                curveToRelative(2.85f, 0.32f, 3.95f, 0.81f, 4f, 0.83f)
                ...
                curveToRelative(0.03f, 0.27f, -0.17f, 0.52f, -0.44f, 0.55f)
                curveToRelative(-1.96f, 0.22f, -3.04f, 0.52f, -3.47f, 0.67f)
                curveToRelative(-0.17f, 0.89f, -0.71f, 3.87f, -0.91f, 7.07f)
                curveToRelative(-0.01f, 0.15f, -0.08f, 0.28f, -0.2f, 0.37f)
                curveToRelative(-0.74f, 0.55f, -1.37f, 1.19f, -1.87f, 1.9f)
                curveToRelative(0.5f, 0.71f, 1.13f, 1.34f, 1.87f, 1.9f)
                curveToRelative(0.12f, 0.09f, 0.19f, 0.22f, 0.2f, 0.37f)
                curveToRelative(0.2f, 3.2f, 0.74f, 6.18f, 0.91f, 7.07f)
                curveToRelative(0.44f, 0.14f, 1.51f, 0.45f, 3.47f, 0.67f)
                curveToRelative(0.27f, 0.03f, 0.47f, 0.28f, 0.44f, 0.55f)
