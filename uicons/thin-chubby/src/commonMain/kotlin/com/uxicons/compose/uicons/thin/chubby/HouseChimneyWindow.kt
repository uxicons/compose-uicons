...
val Icons.Tc.HouseChimneyWindow: ImageVector
    get() = _HouseChimneyWindow ?: UXIcon(name = "HouseChimneyWindow") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(14.79f, 10.36f)
                curveToRelative(-0.05f, -0.01f, -1.31f, -0.36f, -2.79f, -0.36f)
                reflectiveCurveToRelative(-2.74f, 0.35f, -2.79f, 0.36f)
                curveToRelative(-0.17f, 0.05f, -0.29f, 0.17f, -0.34f, 0.34f)
                curveToRelative(-0.01f, 0.05f, -0.37f, 1.23f, -0.37f, 2.8f)
                curveToRelative(0f, 1.58f, 0.35f, 2.75f, 0.37f, 2.8f)
                ...
                curveToRelative(-0.05f, -0.16f, -0.18f, -0.29f, -0.34f, -0.34f)
                close()
                moveTo(14.25f, 15.74f)
                curveToRelative(-0.42f, 0.1f, -1.29f, 0.26f, -2.25f, 0.26f)
                reflectiveCurveToRelative(-1.82f, -0.16f, -2.25f, -0.26f)
                curveToRelative(-0.1f, -0.41f, -0.25f, -1.24f, -0.25f, -2.24f)
                curveToRelative(0f, -1.0f, 0.16f, -1.83f, 0.26f, -2.24f)
                curveToRelative(0.42f, -0.1f, 1.29f, -0.26f, 2.25f, -0.26f)
                reflectiveCurveToRelative(1.82f, 0.16f, 2.25f, 0.26f)
                curveToRelative(0.1f, 0.41f, 0.25f, 1.24f, 0.25f, 2.24f)
                curveToRelative(0f, 1.0f, -0.16f, 1.83f, -0.26f, 2.24f)
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 3.19f, 1.03f, 6.33f, 1.08f, 6.46f)
                ...
                curveToRelative(0.04f, -0.13f, 1.08f, -3.26f, 1.08f, -6.46f)
                curveToRelative(0f, -5.32f, -1.48f, -8.01f, -1.54f, -8.12f)
                close()
                moveTo(21.04f, 20.55f)
                curveToRelative(-0.85f, 0.32f, -4.21f, 1.45f, -9.04f, 1.45f)
                reflectiveCurveToRelative(-8.2f, -1.14f, -9.04f, -1.45f)
                curveToRelative(-0.23f, -0.76f, -0.96f, -3.35f, -0.96f, -5.92f)
