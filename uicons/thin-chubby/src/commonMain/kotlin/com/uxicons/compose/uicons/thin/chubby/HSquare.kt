...
val Icons.Tc.HSquare: ImageVector
    get() = _HSquare ?: UXIcon(name = "HSquare") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(16.43f, 6.38f)
                ...
                curveToRelative(-0.64f, -0.15f, -2.31f, -0.51f, -3.99f, -0.51f)
                ...
                curveToRelative(-0.05f, -2.91f, -0.52f, -4.84f, -0.52f, -4.87f)
                curveToRelative(-0.07f, -0.27f, 0.1f, -0.54f, 0.36f, -0.61f)
