...
val Icons.Tc.TemperatureHigh: ImageVector
    get() = _TemperatureHigh ?: UXIcon(name = "TemperatureHigh") {
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.01f, -1.72f, -0.04f, -5.05f, -0.09f, -5.75f)
                curveToRelative(-0.13f, -2.01f, -1.85f, -3.58f, -3.91f, -3.58f)
                reflectiveCurveToRelative(-3.78f, 1.57f, -3.91f, 3.58f)
                curveToRelative(-0.04f, 0.7f, -0.08f, 4.03f, -0.09f, 5.75f)
                curveToRelative(-1.87f, 0.98f, -2.79f, 2.93f, -2.79f, 5.94f)
                ...
                curveToRelative(0.01f, -2.11f, 0.04f, -5.37f, 0.09f, -6.0f)
                curveToRelative(0.1f, -1.48f, 1.38f, -2.65f, 2.92f, -2.65f)
                reflectiveCurveToRelative(2.82f, 1.16f, 2.92f, 2.65f)
                curveToRelative(0.04f, 0.63f, 0.08f, 3.89f, 0.09f, 6.0f)
