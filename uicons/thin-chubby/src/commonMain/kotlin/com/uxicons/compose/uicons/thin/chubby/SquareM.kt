...
val Icons.Tc.SquareM: ImageVector
    get() = _SquareM ?: UXIcon(name = "SquareM") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(15.19f, 6.27f)
                ...
                curveToRelative(0.18f, -0.02f, 0.34f, 0.08f, 0.44f, 0.23f)
                curveToRelative(0.06f, 0.1f, 1.35f, 2.1f, 2.33f, 5.32f)
                curveToRelative(0.98f, -3.21f, 2.27f, -5.22f, 2.33f, -5.32f)
                curveToRelative(0.1f, -0.15f, 0.27f, -0.24f, 0.44f, -0.23f)
