...
val Icons.Tc.Up: ImageVector
    get() = _Up ?: UXIcon(name = "Up") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(12f, 23f)
                curveToRelative(-2.78f, 0f, -4.09f, -0.58f, -4.14f, -0.61f)
                ...
                curveToRelative(0.18f, 0.26f, 0.04f, 0.66f, -0.26f, 0.75f)
                curveToRelative(-0.07f, 0.02f, -1.64f, 0.53f, -4.71f, 0.84f)
                ...
                curveToRelative(0.77f, 0.18f, 2.22f, 0.48f, 4.33f, 0.67f)
