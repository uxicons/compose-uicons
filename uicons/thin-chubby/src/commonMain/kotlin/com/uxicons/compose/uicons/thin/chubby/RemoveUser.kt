...
val Icons.Tc.RemoveUser: ImageVector
    get() = _RemoveUser ?: UXIcon(name = "RemoveUser") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(9.44f, 14.29f)
                curveToRelative(-5.25f, 0.03f, -8.08f, 2.87f, -8.18f, 8.2f)
                ...
                curveToRelative(4.69f, 0.03f, 7.1f, 2.46f, 7.18f, 7.21f)
                curveToRelative(0.01f, 0.28f, 0.23f, 0.49f, 0.51f, 0.49f)
