...
val Icons.Tc.LessThanEqual: ImageVector
    get() = _LessThanEqual ?: UXIcon(name = "LessThanEqual") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-1.44f, -0.37f, -4.45f, -0.98f, -8.38f, -0.98f)
                ...
                curveToRelative(1.6f, -1.44f, 8.08f, -6.83f, 16.31f, -7.5f)
                curveToRelative(0.28f, -0.02f, 0.48f, -0.26f, 0.46f, -0.54f)
                curveToRelative(-0.02f, -0.27f, -0.27f, -0.48f, -0.54f, -0.46f)
                curveToRelative(-9.84f, 0.81f, -17.01f, 7.84f, -17.31f, 8.14f)
