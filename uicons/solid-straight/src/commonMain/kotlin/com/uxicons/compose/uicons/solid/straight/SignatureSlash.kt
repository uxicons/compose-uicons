...
val Icons.Ss.SignatureSlash: ImageVector
    get() = _SignatureSlash ?: UXIcon(name = "SignatureSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.81f, 0f, -1.61f, 0.32f, -2.24f, 0.85f)
                ...
                curveToRelative(0.87f, -0.78f, 1.55f, -1.86f, 2f, -3.22f)
                close()
                moveTo(14.51f, 12f)
                ...
                curveToRelative(0f, 0.02f, 0f, 0.06f, 0f, 0.08f)
                ...
                curveToRelative(-1.65f, 0f, -3.26f, -0.97f, -4.67f, -2.45f)
                curveToRelative(-1.56f, 1.47f, -3.36f, 2.45f, -5.33f, 2.45f)
                verticalLineToRelative(-2f)
                curveToRelative(1.39f, 0f, 2.77f, -0.8f, 4.02f, -2.01f)
                curveTo(1.62f, 14.72f, 0f, 10.22f, 0f, 7.5f)
                curveToRelative(0f, -0.89f, 0.26f, -1.77f, 0.69f, -2.57f)
                lineToRelative(1.5f, 1.5f)
                curveToRelative(-0.12f, 0.35f, -0.19f, 0.7f, -0.19f, 1.07f)
                curveToRelative(0f, 2.38f, 1.46f, 6.16f, 3.39f, 8.94f)
                ...
                curveToRelative(1.23f, 0f, 2.23f, -0.45f, 3.03f, -1.07f)
