...
val Icons.Ss.Euro: ImageVector
    get() = _Euro ?: UXIcon(name = "Euro") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(14f, 22f)
                arcToRelative(10.02f, 10.02f, 0f, isMoreThanHalf = false, isPositiveArc = true, -9.54f, -7f)
                ...
                arcToRelative(11.99f, 11.99f, 0f, isMoreThanHalf = false, isPositiveArc = false, 20.86f, 4.64f)
                lineToRelative(-1.54f, -1.27f)
                arcToRelative(9.98f, 9.98f, 0f, isMoreThanHalf = false, isPositiveArc = true, -7.72f, 3.64f)
                close()
            }
        }.also { _Euro = it}
