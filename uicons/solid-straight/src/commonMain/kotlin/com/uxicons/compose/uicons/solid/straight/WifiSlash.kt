...
val Icons.Ss.WifiSlash: ImageVector
    get() = _WifiSlash ?: UXIcon(name = "WifiSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(13.6f, 12.19f)
                curveToRelative(1.25f, 0.29f, 2.41f, 0.92f, 3.35f, 1.86f)
                lineToRelative(1.41f, -1.41f)
                curveToRelative(-1.84f, -1.84f, -4.34f, -2.77f, -6.92f, -2.6f)
                lineTo(7.25f, 5.83f)
                curveToRelative(5.1f, -1.85f, 10.77f, -0.62f, 14.65f, 3.27f)
                lineToRelative(1.41f, -1.41f)
