...
val Icons.Ss.SunglassesAlt: ImageVector
    get() = _SunglassesAlt ?: UXIcon(name = "SunglassesAlt") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(2.21f, 0f, 4f, -1.79f, 4f, -4f)
                verticalLineToRelative(-4.89f)
                curveToRelative(0f, -0.46f, -0.04f, -0.91f, -0.1f, -1.36f)
                close()
                moveTo(2f, 15f)
                horizontalLineToRelative(5.0f)
                curveToRelative(0.22f, 0f, 0.43f, 0.04f, 0.63f, 0.11f)
                lineToRelative(-5.63f, 3.39f)
                reflectiveCurveToRelative(0f, -3.46f, 0f, -3.5f)
                close()
                moveTo(17.0f, 15f)
                horizontalLineToRelative(3.68f)
                lineToRelative(-5.68f, 3.46f)
