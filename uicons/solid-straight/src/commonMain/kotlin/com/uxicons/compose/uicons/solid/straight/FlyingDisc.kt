...
val Icons.Ss.FlyingDisc: ImageVector
    get() = _FlyingDisc ?: UXIcon(name = "FlyingDisc") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(0.04f, 17.07f)
                curveToRelative(-0.18f, -3.67f, 1.69f, -8.13f, 5.3f, -11.74f)
                curveTo(7.94f, 2.73f, 11.06f, 0.93f, 14.11f, 0.27f)
                curveTo(15.13f, 0.05f, 16.1f, -0.03f, 17.01f, 0.01f)
