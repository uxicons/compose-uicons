...
val Icons.Sc.LightSwitchOff: ImageVector
    get() = _LightSwitchOff ?: UXIcon(name = "LightSwitchOff") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(9.76f, 16.79f)
            ...
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(14.38f, 8.63f)
                curveToRelative(-0.73f, -0.12f, -1.54f, -0.19f, -2.38f, -0.19f)
                reflectiveCurveToRelative(-1.64f, 0.08f, -2.38f, 0.19f)
                curveToRelative(-0.06f, 0.72f, -0.1f, 1.52f, -0.12f, 2.37f)
                horizontalLineToRelative(4.99f)
                curveToRelative(-0.02f, -0.78f, -0.06f, -1.58f, -0.12f, -2.37f)
                close()
            }
