...
val Icons.Sc.Square1: ImageVector
    get() = _Square1 ?: UXIcon(name = "Square1") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.45f, 0.34f, -0.85f, 0.86f, -1.02f, 1.68f)
                curveToRelative(-0.11f, 0.54f, -0.64f, 0.88f, -1.18f, 0.77f)
                curveToRelative(-0.54f, -0.11f, -0.89f, -0.64f, -0.77f, -1.18f)
                curveToRelative(0.58f, -2.77f, 2.82f, -3.56f, 3.76f, -3.77f)
                curveToRelative(0.3f, -0.07f, 0.61f, 0.01f, 0.84f, 0.2f)
