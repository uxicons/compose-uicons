...
val Icons.Sc.SquareL: ImageVector
    get() = _SquareL ?: UXIcon(name = "SquareL") {
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveToRelative(-0.98f, -9.02f, -1.02f, -9.21f)
                close()
                moveTo(16.18f, 17.63f)
                curveToRelative(-0.67f, 0.12f, -1.85f, 0.36f, -3.43f, 0.37f)
                ...
                curveToRelative(1.4f, -0.01f, 2.45f, -0.22f, 3.07f, -0.33f)
                curveToRelative(0.55f, -0.11f, 1.06f, 0.26f, 1.17f, 0.8f)
                reflectiveCurveToRelative(-0.26f, 1.06f, -0.8f, 1.17f)
                close()
            }
        }.also { _SquareL = it}
