...
val Icons.Sc.CustomerService: ImageVector
    get() = _CustomerService ?: UXIcon(name = "CustomerService") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.84f, 0f, -1.52f, -0.7f, -1.5f, -1.54f)
                ...
                close()
                moveTo(16.08f, 17.57f)
                curveToRelative(-0.52f, 1.25f, -1.2f, 2.41f, -1.77f, 3.1f)
                curveToRelative(-0.37f, 0.44f, -1.07f, 0.45f, -1.42f, -0.01f)
                curveToRelative(-0.38f, -0.48f, -0.68f, -1.03f, -0.89f, -1.65f)
                curveToRelative(-0.21f, 0.6f, -0.5f, 1.14f, -0.89f, 1.64f)
                curveToRelative(-0.35f, 0.46f, -1.06f, 0.45f, -1.43f, 0.01f)
                curveToRelative(-0.56f, -0.67f, -1.32f, -1.95f, -1.83f, -3.06f)
                curveToRelative(-1.68f, 0.61f, -3.16f, 1.8f, -3.81f, 4.14f)
                ...
                curveToRelative(-0.66f, -2.37f, -2.18f, -3.57f, -3.88f, -4.17f)
                close()
            }
