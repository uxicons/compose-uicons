...
val Icons.Sc.WindowFrameOpen: ImageVector
    get() = _WindowFrameOpen ?: UXIcon(name = "WindowFrameOpen") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(19.96f, 11f)
                ...
                curveToRelative(0.04f, 0.11f, 0.88f, 2.54f, 1.08f, 7.28f)
                curveToRelative(0.02f, 0.57f, -0.43f, 1.05f, -1.0f, 1.05f)
                close()
                moveTo(4.04f, 11f)
                horizontalLineToRelative(6.96f)
                verticalLineToRelative(-9.98f)
