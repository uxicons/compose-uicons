...
val Icons.Sc.BookArrowUp: ImageVector
    get() = _BookArrowUp ?: UXIcon(name = "BookArrowUp") {
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.18f, 0.23f, -0.34f, 0.48f, -0.47f, 0.76f)
                curveToRelative(-0.23f, 0.5f, -0.82f, 0.73f, -1.32f, 0.5f)
                curveToRelative(-0.5f, -0.23f, -0.73f, -0.82f, -0.5f, -1.32f)
                curveToRelative(0.87f, -1.94f, 2.76f, -2.92f, 2.84f, -2.96f)
                curveToRelative(0.28f, -0.14f, 0.62f, -0.14f, 0.9f, -0.0f)
                curveToRelative(0.08f, 0.04f, 1.98f, 1.01f, 2.85f, 2.96f)
                curveToRelative(0.06f, 0.13f, 0.31f, 0.92f, -0.51f, 1.32f)
                curveToRelative(-0.49f, 0.24f, -1.1f, -0.0f, -1.32f, -0.51f)
                curveToRelative(-0.13f, -0.28f, -0.29f, -0.54f, -0.47f, -0.76f)
