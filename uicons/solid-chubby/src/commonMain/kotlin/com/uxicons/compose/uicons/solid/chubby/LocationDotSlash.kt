...
val Icons.Sc.LocationDotSlash: ImageVector
    get() = _LocationDotSlash ?: UXIcon(name = "LocationDotSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, 0.92f, -0.09f, 2.13f, -0.74f, 3.14f)
                lineToRelative(-1.49f, -1.49f)
                curveToRelative(0.14f, -0.37f, 0.23f, -0.9f, 0.23f, -1.65f)
                curveToRelative(0f, -1.95f, -0.48f, -3f, -3f, -3f)
                curveToRelative(-0.75f, 0f, -1.27f, 0.1f, -1.65f, 0.23f)
                lineToRelative(-1.49f, -1.49f)
                curveToRelative(0.79f, -0.5f, 1.83f, -0.74f, 3.14f, -0.74f)
                close()
            }
            path(fill = SolidColor(Color.Black)) {
