...
val Icons.Sc.SwipeUp: ImageVector
    get() = _SwipeUp ?: UXIcon(name = "SwipeUp") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0f, -0.21f, 0.07f, -0.42f, 0.2f, -0.6f)
                ...
                curveToRelative(0.23f, 0.3f, 0.26f, 0.71f, 0.09f, 1.05f)
                ...
                close()
                moveTo(22.4f, 12.11f)
                curveToRelative(-1.29f, -0.93f, -3.99f, -2.14f, -7.7f, -2.61f)
                curveToRelative(-0.09f, -3.04f, -0.37f, -5.01f, -0.8f, -6.53f)
