...
val Icons.Sc.MessageQuote: ImageVector
    get() = _MessageQuote ?: UXIcon(name = "MessageQuote") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(11f, 12.08f)
                curveToRelative(0.06f, 0.84f, -0.16f, 3.63f, -3.0f, 3.92f)
                curveToRelative(-0.47f, 0f, -0.9f, -0.34f, -0.98f, -0.82f)
                curveToRelative(-0.1f, -0.54f, 0.26f, -1.06f, 0.81f, -1.16f)
                curveToRelative(0.69f, -0.07f, 1.23f, -0.5f, 1.18f, -2.04f)
                curveToRelative(-0.16f, 0.01f, -0.33f, 0.02f, -0.5f, 0.02f)
                curveToRelative(-0.77f, 0f, -1.53f, -0.17f, -1.56f, -0.17f)
                curveToRelative(-0.38f, -0.08f, -0.68f, -0.38f, -0.76f, -0.76f)
                curveToRelative(-0.01f, -0.03f, -0.17f, -0.8f, -0.17f, -1.56f)
                reflectiveCurveToRelative(0.17f, -1.53f, 0.17f, -1.56f)
                curveToRelative(0.08f, -0.38f, 0.38f, -0.68f, 0.76f, -0.76f)
                curveToRelative(0.03f, -0.01f, 0.8f, -0.17f, 1.56f, -0.17f)
                reflectiveCurveToRelative(1.53f, 0.17f, 1.56f, 0.17f)
                curveToRelative(0.38f, 0.08f, 0.68f, 0.38f, 0.76f, 0.76f)
                curveToRelative(0.01f, 0.03f, 0.17f, 0.8f, 0.17f, 1.56f)
                close()
                moveTo(18f, 12.08f)
