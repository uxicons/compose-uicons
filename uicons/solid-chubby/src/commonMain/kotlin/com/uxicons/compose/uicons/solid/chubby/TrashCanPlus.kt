...
val Icons.Sc.TrashCanPlus: ImageVector
    get() = _TrashCanPlus ?: UXIcon(name = "TrashCanPlus") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.19f, 0.45f, 0.67f, 0.67f, 1.14f, 0.57f)
                ...
                curveToRelative(0f, -2.07f, -0.07f, -3.91f, -0.22f, -5.42f)
                curveToRelative(0.45f, 0.15f, 0.95f, -0.12f, 1.14f, -0.57f)
