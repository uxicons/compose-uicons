...
val Icons.Sc.FaceAnguished: ImageVector
    get() = _FaceAnguished ?: UXIcon(name = "FaceAnguished") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.6f, 0f, -1.09f, -0.52f, -1.01f, -1.1f)
                curveToRelative(0.29f, -2.05f, 1.5f, -2.9f, 3.99f, -2.9f)
                reflectiveCurveToRelative(3.7f, 0.84f, 3.99f, 2.9f)
                curveToRelative(0.08f, 0.59f, -0.41f, 1.1f, -1.01f, 1.1f)
                close()
                moveTo(14.5f, 12f)
                curveToRelative(-0.83f, 0f, -1.5f, -0.67f, -1.5f, -1.5f)
                reflectiveCurveToRelative(0.67f, -1.5f, 1.5f, -1.5f)
