...
val Icons.Sc.BatteryFull: ImageVector
    get() = _BatteryFull ?: UXIcon(name = "BatteryFull") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(7.11f, 10.23f)
                curveToRelative(-0.08f, 0.6f, -0.11f, 1.19f, -0.11f, 1.77f)
                reflectiveCurveToRelative(0.04f, 1.17f, 0.11f, 1.77f)
                curveToRelative(2.7f, 0.31f, 5.07f, 0.31f, 7.77f, 0f)
                curveToRelative(0.08f, -0.6f, 0.11f, -1.19f, 0.11f, -1.77f)
                reflectiveCurveToRelative(-0.04f, -1.17f, -0.11f, -1.77f)
                curveToRelative(-2.71f, -0.31f, -5.07f, -0.31f, -7.77f, 0f)
                close()
            }
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(16.75f, 14.84f)
                curveToRelative(-0.08f, 0.43f, -0.42f, 0.76f, -0.85f, 0.82f)
                curveToRelative(-1.7f, 0.23f, -3.35f, 0.34f, -4.89f, 0.34f)
                reflectiveCurveToRelative(-3.19f, -0.12f, -4.89f, -0.34f)
                curveToRelative(-0.43f, -0.06f, -0.78f, -0.39f, -0.85f, -0.82f)
                curveToRelative(-0.17f, -0.95f, -0.25f, -1.91f, -0.25f, -2.84f)
                reflectiveCurveToRelative(0.09f, -1.88f, 0.25f, -2.84f)
                curveToRelative(0.08f, -0.43f, 0.42f, -0.76f, 0.85f, -0.82f)
                curveToRelative(1.71f, -0.23f, 3.35f, -0.34f, 4.89f, -0.34f)
                reflectiveCurveToRelative(3.19f, 0.12f, 4.89f, 0.34f)
                curveToRelative(0.43f, 0.06f, 0.78f, 0.39f, 0.85f, 0.82f)
                curveToRelative(0.17f, 0.95f, 0.25f, 1.91f, 0.25f, 2.84f)
                reflectiveCurveToRelative(-0.09f, 1.89f, -0.25f, 2.84f)
                close()
            }
