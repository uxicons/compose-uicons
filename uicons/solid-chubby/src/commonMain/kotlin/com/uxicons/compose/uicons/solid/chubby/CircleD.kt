...
val Icons.Sc.CircleD: ImageVector
    get() = _CircleD ?: UXIcon(name = "CircleD") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(12f, 18f)
                curveToRelative(-1.12f, 0f, -2.58f, -0.21f, -2.64f, -0.21f)
                curveToRelative(-0.39f, -0.06f, -0.72f, -0.34f, -0.82f, -0.72f)
                curveToRelative(-0.02f, -0.08f, -0.54f, -1.96f, -0.54f, -5.06f)
                reflectiveCurveToRelative(0.51f, -5.0f, 0.54f, -5.08f)
                curveToRelative(0.11f, -0.39f, 0.44f, -0.68f, 0.84f, -0.73f)
                curveToRelative(0.06f, -0.01f, 1.51f, -0.19f, 2.62f, -0.19f)
