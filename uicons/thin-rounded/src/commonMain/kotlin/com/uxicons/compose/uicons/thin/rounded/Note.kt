...
val Icons.Tr.Note: ImageVector
    get() = _Note ?: UXIcon(name = "Note") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-1.93f, 0f, -3.5f, -1.57f, -3.5f, -3.5f)
                close()
                moveTo(21.98f, 18.82f)
                lineToRelative(-3.16f, 3.16f)
                curveToRelative(-0.49f, 0.49f, -1.14f, 0.83f, -1.82f, 0.96f)
                verticalLineToRelative(-4.44f)
                curveToRelative(0f, -0.83f, 0.67f, -1.5f, 1.5f, -1.5f)
                horizontalLineToRelative(4.44f)
                curveToRelative(-0.13f, 0.69f, -0.46f, 1.31f, -0.96f, 1.82f)
                close()
                moveTo(4f, 6f)
