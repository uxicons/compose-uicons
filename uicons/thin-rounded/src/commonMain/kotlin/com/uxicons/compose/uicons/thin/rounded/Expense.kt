...
val Icons.Tr.Expense: ImageVector
    get() = _Expense ?: UXIcon(name = "Expense") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(-2.58f, -2.65f)
                curveToRelative(-0.19f, -0.2f, -0.19f, -0.51f, 0.01f, -0.71f)
                curveToRelative(0.2f, -0.19f, 0.51f, -0.19f, 0.71f, 0.01f)
                lineToRelative(2.7f, 2.77f)
                curveToRelative(0.24f, 0.24f, 0.44f, 0.6f, 0.44f, 1.07f)
                reflectiveCurveToRelative(-0.21f, 0.81f, -0.45f, 1.04f)
