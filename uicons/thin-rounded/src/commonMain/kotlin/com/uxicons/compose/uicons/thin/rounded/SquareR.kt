...
val Icons.Tr.SquareR: ImageVector
    get() = _SquareR ?: UXIcon(name = "SquareR") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.06f, 0f, 0.13f, -0.0f, 0.19f, -0.0f)
                lineToRelative(2.86f, 5.73f)
                ...
                lineToRelative(-2.71f, -5.43f)
                curveToRelative(2.16f, -0.55f, 3.77f, -2.51f, 3.77f, -4.85f)
                close()
                moveTo(14f, 13f)
                lineTo(6f, 13f)
                verticalLineToRelative(-5.5f)
