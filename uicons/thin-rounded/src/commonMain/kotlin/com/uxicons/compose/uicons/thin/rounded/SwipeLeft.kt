...
val Icons.Tr.SwipeLeft: ImageVector
    get() = _SwipeLeft ?: UXIcon(name = "SwipeLeft") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(17.48f, 10.53f)
                lineToRelative(-6.47f, -1.44f)
                lineTo(11f, 2.61f)
                ...
                lineToRelative(4.84f, 4.61f)
                curveToRelative(1.4f, 1.33f, 3.24f, 2.07f, 5.17f, 2.07f)
                horizontalLineToRelative(5.7f)
                curveToRelative(2.48f, 0f, 4.5f, -2.02f, 4.5f, -4.5f)
                verticalLineToRelative(-4.57f)
                curveToRelative(0f, -2.13f, -1.45f, -3.93f, -3.52f, -4.39f)
                close()
                moveTo(20f, 19.5f)
                curveToRelative(0f, 1.93f, -1.57f, 3.5f, -3.5f, 3.5f)
                horizontalLineToRelative(-5.7f)
                curveToRelative(-1.68f, 0f, -3.27f, -0.64f, -4.48f, -1.79f)
                lineToRelative(-4.84f, -4.61f)
                curveToRelative(-0.6f, -0.56f, -0.64f, -1.52f, -0.07f, -2.12f)
                curveToRelative(0.29f, -0.31f, 0.69f, -0.47f, 1.08f, -0.47f)
                curveToRelative(0.37f, 0f, 0.76f, 0.14f, 1.06f, 0.42f)
                ...
                lineToRelative(6.87f, 1.52f)
                curveToRelative(1.61f, 0.36f, 2.74f, 1.76f, 2.74f, 3.42f)
                verticalLineToRelative(4.57f)
                close()
                moveTo(24f, 3.5f)
                curveToRelative(0f, 0.28f, -0.22f, 0.5f, -0.5f, 0.5f)
                horizontalLineToRelative(-8.31f)
                curveToRelative(0.03f, 0.04f, 0.05f, 0.09f, 0.1f, 0.13f)
