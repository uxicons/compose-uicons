...
val Icons.Tr.VenusMars: ImageVector
    get() = _VenusMars ?: UXIcon(name = "VenusMars") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(23.43f, 0.61f)
                curveToRelative(-0.01f, -0.01f, -0.01f, -0.01f, -0.02f, -0.02f)
                curveToRelative(-0.01f, -0.01f, -0.01f, -0.01f, -0.02f, -0.02f)
                curveToRelative(-0.36f, -0.35f, -0.85f, -0.57f, -1.39f, -0.57f)
                ...
                reflectiveCurveToRelative(0.5f, -0.22f, 0.5f, -0.5f)
                verticalLineToRelative(-3.5f)
                curveToRelative(0f, -0.54f, -0.22f, -1.03f, -0.57f, -1.39f)
                close()
                moveTo(6.5f, 16f)
