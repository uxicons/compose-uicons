...
val Icons.Tr.RunningTrack: ImageVector
    get() = _RunningTrack ?: UXIcon(name = "RunningTrack") {
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(16.67f, 4f)
                curveToRelative(-0.05f, -0.02f, -8.67f, 0f, -8.67f, 0f)
                curveTo(3.59f, 4f, 0f, 7.59f, 0f, 12f)
                reflectiveCurveToRelative(3.59f, 8f, 8f, 8f)
                horizontalLineToRelative(8f)
                curveToRelative(4.41f, 0f, 8f, -3.59f, 8f, -8f)
                curveToRelative(0f, -4.19f, -3.23f, -7.66f, -7.33f, -8f)
                close()
                moveTo(16f, 7f)
