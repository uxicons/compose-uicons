...
val Icons.Tr.PersonSeat: ImageVector
    get() = _PersonSeat ?: UXIcon(name = "PersonSeat") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.67f, 0f, -1.26f, -0.45f, -1.44f, -1.09f)
                lineToRelative(-1.38f, -4.82f)
                curveToRelative(-0.18f, -0.64f, -0.78f, -1.09f, -1.44f, -1.09f)
                ...
                horizontalLineToRelative(6.49f)
                curveToRelative(1.11f, 0f, 2.1f, 0.74f, 2.4f, 1.81f)
                lineToRelative(1.38f, 4.82f)
