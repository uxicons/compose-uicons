...
val Icons.Tr.CallOutgoing: ImageVector
    get() = _CallOutgoing ?: UXIcon(name = "CallOutgoing") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(23.16f, 17.3f)
                curveToRelative(1.1f, 1.09f, 1.1f, 2.8f, 0.05f, 3.85f)
                lineToRelative(-0.98f, 1.12f)
                curveToRelative(-1.12f, 1.12f, -2.61f, 1.73f, -4.21f, 1.73f)
                curveTo(10.28f, 24f, 0f, 13.72f, 0f, 5.98f)
                curveToRelative(0f, -1.6f, 0.6f, -3.09f, 1.7f, -4.19f)
                lineToRelative(1.18f, -1.02f)
                curveToRelative(0.96f, -0.97f, 2.76f, -0.99f, 3.78f, 0.02f)
                ...
                curveToRelative(1.02f, -1.01f, 2.79f, -1.01f, 3.8f, 0.0f)
                ...
                curveToRelative(-0.07f, -0.18f, -0.03f, -0.39f, 0.1f, -0.54f)
                lineToRelative(1.72f, -1.77f)
                curveToRelative(0.66f, -0.66f, 0.66f, -1.74f, 0.01f, -2.4f)
                lineToRelative(-1.96f, -2.54f)
