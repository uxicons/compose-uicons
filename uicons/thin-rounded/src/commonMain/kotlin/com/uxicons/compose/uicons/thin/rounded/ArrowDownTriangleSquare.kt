...
val Icons.Tr.ArrowDownTriangleSquare: ImageVector
    get() = _ArrowDownTriangleSquare ?: UXIcon(name = "ArrowDownTriangleSquare") {
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(3.59f, 3.41f)
                curveToRelative(0.17f, 0.17f, 0.36f, 0.29f, 0.57f, 0.36f)
                lineTo(5.01f, 0.5f)
                ...
                close()
                moveTo(23.29f, 9.04f)
                curveToRelative(-0.36f, 0.6f, -0.99f, 0.96f, -1.69f, 0.96f)
                horizontalLineToRelative(-6.21f)
                curveToRelative(-0.7f, 0f, -1.33f, -0.36f, -1.69f, -0.96f)
                curveToRelative(-0.36f, -0.6f, -0.37f, -1.33f, -0.04f, -1.94f)
                lineToRelative(3.12f, -5.09f)
                curveToRelative(0.34f, -0.62f, 0.98f, -1.01f, 1.72f, -1.01f)
                reflectiveCurveToRelative(1.38f, 0.38f, 1.73f, 1.03f)
                lineToRelative(3.09f, 5.04f)
                curveToRelative(0.35f, 0.64f, 0.33f, 1.36f, -0.03f, 1.97f)
                close()
                moveTo(22.45f, 7.57f)
                lineToRelative(-3.09f, -5.04f)
                curveToRelative(-0.18f, -0.34f, -0.5f, -0.53f, -0.86f, -0.53f)
                reflectiveCurveToRelative(-0.68f, 0.19f, -0.85f, 0.51f)
                lineToRelative(-3.12f, 5.09f)
                curveToRelative(-0.15f, 0.28f, -0.14f, 0.64f, 0.03f, 0.93f)
                curveToRelative(0.18f, 0.3f, 0.49f, 0.47f, 0.83f, 0.47f)
                horizontalLineToRelative(6.21f)
                curveToRelative(0.34f, 0f, 0.65f, -0.18f, 0.83f, -0.47f)
                curveToRelative(0.18f, -0.3f, 0.18f, -0.65f, 0.02f, -0.96f)
                close()
            }
