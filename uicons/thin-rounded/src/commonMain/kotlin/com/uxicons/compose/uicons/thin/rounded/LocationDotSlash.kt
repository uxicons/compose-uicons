...
val Icons.Tr.LocationDotSlash: ImageVector
    get() = _LocationDotSlash ?: UXIcon(name = "LocationDotSlash") {
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.83f, -0.75f, 1.32f, -1.83f, 1.32f, -2.97f)
                curveToRelative(0f, -2.21f, -1.79f, -4f, -4f, -4f)
                curveToRelative(-1.14f, 0f, -2.22f, 0.49f, -2.97f, 1.32f)
                lineTo(4.78f, 4.07f)
                curveToRelative(0.05f, -0.05f, 0.1f, -0.1f, 0.15f, -0.15f)
                close()
                moveTo(9.74f, 9.03f)
                ...
                curveToRelative(0f, 0.87f, -0.38f, 1.7f, -1.03f, 2.26f)
                ...
                curveToRelative(0.12f, -0.25f, 0.41f, -0.35f, 0.67f, -0.24f)
