...
val Icons.Tr.Peace: ImageVector
    get() = _Peace ?: UXIcon(name = "Peace") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(23f, 12f)
                curveToRelative(0f, 2.3f, -0.71f, 4.44f, -1.92f, 6.21f)
                lineToRelative(-8.58f, -8.42f)
                lineTo(12.5f, 1.01f)
                ...
                lineTo(2.91f, 18.18f)
                curveToRelative(-1.2f, -1.76f, -1.91f, -3.89f, -1.91f, -6.18f)
                curveTo(1f, 6.1f, 5.67f, 1.27f, 11.5f, 1.01f)
                close()
                moveTo(3.51f, 18.99f)
                lineToRelative(7.99f, -7.8f)
                verticalLineToRelative(11.8f)
                curveToRelative(-3.21f, -0.14f, -6.07f, -1.67f, -7.99f, -4.0f)
                close()
                moveTo(12.5f, 22.99f)
                verticalLineToRelative(-11.8f)
                lineToRelative(7.97f, 7.82f)
                curveToRelative(-1.92f, 2.31f, -4.77f, 3.83f, -7.97f, 3.98f)
                close()
            }
        }.also { _Peace = it}
