...
val Icons.Tr.PreviousSquare: ImageVector
    get() = _PreviousSquare ?: UXIcon(name = "PreviousSquare") {
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(16.18f, 7.16f)
                curveToRelative(-0.51f, -0.26f, -1.11f, -0.2f, -1.53f, 0.11f)
                ...
                curveToRelative(-0.17f, 0.09f, -0.36f, 0.07f, -0.55f, -0.06f)
                lineToRelative(-5.48f, -3.48f)
                curveToRelative(-0.13f, -0.09f, -0.2f, -0.24f, -0.2f, -0.4f)
                reflectiveCurveToRelative(0.07f, -0.3f, 0.17f, -0.38f)
                lineToRelative(5.54f, -3.52f)
                curveToRelative(0.09f, -0.07f, 0.19f, -0.1f, 0.29f, -0.1f)
                curveToRelative(0.08f, 0f, 0.15f, 0.02f, 0.22f, 0.05f)
                curveToRelative(0.17f, 0.09f, 0.27f, 0.25f, 0.27f, 0.44f)
                verticalLineToRelative(7.01f)
                close()
            }
