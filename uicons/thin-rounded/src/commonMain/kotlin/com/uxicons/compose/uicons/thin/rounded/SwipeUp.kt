...
val Icons.Tr.SwipeUp: ImageVector
    get() = _SwipeUp ?: UXIcon(name = "SwipeUp") {
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(3f, 9.5f)
                lineTo(3f, 1.2f)
                curveToRelative(-0.04f, 0.03f, -0.09f, 0.05f, -0.13f, 0.09f)
                lineTo(0.86f, 3.43f)
                ...
                lineTo(2.14f, 0.6f)
                curveToRelative(0.33f, -0.35f, 0.86f, -0.6f, 1.36f, -0.6f)
                reflectiveCurveToRelative(1.01f, 0.27f, 1.32f, 0.59f)
                ...
                lineToRelative(-2.04f, -2.15f)
                curveToRelative(-0.03f, -0.03f, -0.06f, -0.04f, -0.09f, -0.07f)
